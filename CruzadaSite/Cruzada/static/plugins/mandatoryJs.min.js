...
(function (b, a) {
    ...
    }, D = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, bS = /^-ms-/, aW = /-([\da-z])/gi, N = function (e, i) {
        return i.toUpperCase()
    };
    bI.fn = bI.prototype = {jquery: ai, constructor: bI, selector: "", length: 0, toArray: function () {
        return O.call(this)
    }, get: function (e) {
    ...
    bI.extend({expando: "jQuery" + (ai + Math.random()).replace(/\D/g, ""), isReady: true, error: function (e) {
        throw new Error(e)
    }, noop: function () {
    ...
    var m =
        ...
        (function (de) {
            var cx, dh, cn, cG, cJ, cV, dl, cH, cW, cY, cB, co, c7, c2, df, ce, cE, c9 = "sizzle" + -(new Date()), cI = de.document, di = 0, c3 = 0, b9 = cz(), c8 = cz(), cF = cz(), cD = function (i, e) {
                if (i === e) {
                    cW = true
                }
                return 0
            }, dd = typeof undefined, cP = 1 << 31, cN = ({}).hasOwnProperty, db = [], dc = db.pop, cL = db.push, b7 = db.push, cm = db.slice, cd = db.indexOf || function (dn) {
            ...
            try {
                ...
                b7 = {apply: db.length ? function (i, e) {
            ...
            function ca(i, e) {
                var dn = e && i, dm = dn && i.nodeType === 1 && e.nodeType === 1 && (~e.sourceIndex || cP) - (~i.sourceIndex || cP);
                if (dm) {
                    return dm
                }
                if (dn) {
            ...
            cn = cv.selectors = {cacheLength: 50, createPseudo: cj, match: c1, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: true}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: true}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
            ...
            function da(ds) {
                var dm, dq, dn, dr = ds.length, dv = cn.relative[ds[0].type], dw = dv || cn.relative[" "], dp = dv ? 1 : 0, dt = cq(function (i) {
                    return i === dm
            ...
            function cX(dn, dm) {
                var e = dm.length > 0, dp = dn.length > 0, i = function (dz, dt, dy, dx, dC) {
                    var du, dv, dA, dE = 0, dw = "0", dq = dz && [], dF = [], dD = dl, ds = dz || dp && cn.find.TAG("*", dC), dr = (di += dD == null ? 1 : Math.random() || 0.1), dB = ds.length;
                    if (dC) {
                        dl = dt !== cB && dt
                    }
    ...
    var y, n = a5.document, bt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, bV = bI.fn.init = function (e, b6) {
        var i, b7;
        if (!e) {
            return this
        }
    ...
    bI.extend({dir: function (b6, i, b8) {
        var e = [], b7 = b6[i];
    ...
    bI.fn.extend({has: function (b8) {
        ...
        var ca, b7 = 0, b6 = this.length, e = [], cb = z.test(b9) || typeof b9 !== "string" ? bI(b9, b8 || this.context) : 0;
        for (; b7 < b6; b7++) {
    ...
    bI.Callbacks = function (ce) {
        ...
        var b8, b7, e, b9, ca, b6, cb = [], cc = !ce.once && [], i = function (cf) {
            b7 = ce.memory && cf;
            e = true;
            ca = b6 || 0;
            b6 = 0;
    ...
    bI.extend({Deferred: function (b6) {
        var i = [
        ...
        var b7 = 0, cb = O.call(arguments), e = cb.length, b6 = e !== 1 || (b9 && bI.isFunction(b9.promise)) ? e : 0, ce = b6 === 1 ? b9 : bI.Deferred(), b8 = function (cg, ch, cf) {
            return function (i) {
                ch[cg] = this;
    ...
    bI.extend({isReady: false, readyWait: 1, holdReady: function (e) {
        if (e) {
            bI.readyWait++
        } else {
            bI.ready(true)
    ...
    bI.extend({cache: {}, noData: {"applet ": true, "embed ": true, "object ": "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"}, hasData: function (e) {
    ...
    bI.fn.extend({data: function (b8, cb) {
    ...
    bI.extend({queue: function (b6, i, b7) {
        var e;
        if (b6) {
            i = (i || "fx") + "queue";
            e = bI._data(b6, i);
        ...
        b8 = b8 || "fx";
        var i = bI.queue(b9, b8), ca = i.length, b7 = i.shift(), e = bI._queueHooks(b9, b8), b6 = function () {
            bI.dequeue(b9, b8)
        };
        if (b7 === "inprogress") {
            b7 = i.shift();
        ...
        var e = i + "queueHooks";
        return bI._data(b6, e) || bI._data(b6, e, {empty: bI.Callbacks("once memory").add(function () {
            bI._removeData(b6, i + "queue");
            bI._removeData(b6, e)
        })})
    }});
    bI.fn.extend({queue: function (e, i) {
        var b6 = 2;
        if (typeof e !== "string") {
            i = e;
            e = "fx";
    ...
    (function () {
        var b6 = n.createDocumentFragment(), b8 = n.createElement("div"), i = n.createElement("input");
    ...
    (function () {
        ...
        for (b6 in {submit: true, change: true, focusin: true}) {
            e = "on" + b6;
    ...
    bI.event = {global: {}, add: function (b8, cd, ci, ca, b9) {
        ...
        var ce, b8, ci, cj, cg, cc, cb, ca = [b9 || n], ch = J.call(b6, "type") ? b6.type : b6, b7 = J.call(b6, "namespace") ? b6.namespace.split(".") : [];
        ci = cc = b9 = b9 || n;
        ...
        if (b8 && cd.nodeType && (!e.button || e.type !== "click")) {
            for (; cd != this; cd = cd.parentNode || this) {
                if (cd.nodeType === 1 && (cd.disabled !== true || e.type !== "click")) {
                    ...
                    if (ca.length) {
                        cb.push({elem: cd, handlers: ca})
                    }
                }
            }
        }
        if (b8 < b7.length) {
            cb.push({elem: this, handlers: b7.slice(b8)})
        }
        return cb
    }, fix: function (b8) {
        if (b8[bI.expando]) {
        ...
        return i
    }}, mouseHooks: {props: "button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "), filter: function (b7, b6) {
        ...
        var b9 = bI.extend(new bI.Event(), b7, {type: b6, isSimulated: true, originalEvent: {}});
        if (i) {
    ...
    bI.Event.prototype = {isDefaultPrevented: Y, isPropagationStopped: Y, isImmediatePropagationStopped: Y, preventDefault: function () {
    ...
    bI.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (i, e) {
        bI.event.special[i] = {delegateType: e, bindType: e, handle: function (b8) {
    ...
    if (!C.submitBubbles) {
        bI.event.special.submit = {setup: function () {
            if (bI.nodeName(this, "form")) {
                return false
            }
            bI.event.add(this, "click._submit keypress._submit", function (b7) {
                var b6 = b7.target, i = bI.nodeName(b6, "input") || bI.nodeName(b6, "button") ? b6.form : undefined;
    ...
    if (!C.changeBubbles) {
        bI.event.special.change = {setup: function () {
    ...
    if (!C.focusinBubbles) {
        bI.each({focus: "focusin", blur: "focusout"}, function (b6, e) {
            var i = function (b7) {
                bI.event.simulate(e, b7.target, bI.event.fix(b7), true)
            };
            bI.event.special[e] = {setup: function () {
                var b8 = this.ownerDocument || this, b7 = bI._data(b8, e);
                if (!b7) {
                    b8.addEventListener(b6, i, true)
                }
                bI._data(b8, e, (b7 || 0) + 1)
            }, teardown: function () {
                var b8 = this.ownerDocument || this, b7 = bI._data(b8, e) - 1;
                if (!b7) {
    ...
    bI.fn.extend({on: function (b6, e, b9, b8, i) {
        var b7, ca;
        if (typeof b6 === "object") {
            if (typeof e !== "string") {
                b9 = b9 || e;
    ...
    bI.extend({clone: function (b6, b8, e) {
    ...
    bI.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (e, i) {
        bI.fn[e] = function (b6) {
    ...
    function a4(e, b7) {
        var i = bI(b7.createElement(e)).appendTo(b7.body), b6 = a5.getDefaultComputedStyle ? a5.getDefaultComputedStyle(i[0]).display : bI.css(i[0], "display");
        i.detach();
        return b6
    }
    ...
    (function () {
        ...
        cb = i = null;
        bI.extend(C, {reliableHiddenOffsets: function () {
            if (cd != null) {
                return cd
            }
        ...
        function b7() {
            ...
            bI.swap(ce, ce.style.zoom != null ? {zoom: 1} : {}, function () {
                b6 = cg.offsetWidth === 4
            });
            ca = true;
            b9 = false;
    ...
    function ax(b9, b6, e, cb, b8) {
        var b7 = e === (cb ? "border" : "content") ? 4 : b6 === "width" ? 1 : 0, ca = 0;
        for (; b7 < 4; b7 += 2) {
            if (e === "margin") {
    ...
    function u(b8, i, e) {
        var b7 = true, b9 = i === "width" ? b8.offsetWidth : b8.offsetHeight, b6 = bq(b8), ca = C.boxSizing() && bI.css(b8, "boxSizing", false, b6) === "border-box";
        if (b9 <= 0 || b9 == null) {
            b9 = F(b8, i, b6);
            if (b9 < 0 || b9 == null) {
                b9 = b8.style[i]
    ...
    bI.extend({cssHooks: {opacity: {get: function (b6, i) {
        if (i) {
            var e = F(b6, "opacity");
            return e === "" ? "1" : e
        }
    }}}, cssNumber: {columnCount: true, fillOpacity: true, fontWeight: true, lineHeight: true, opacity: true, order: true, orphans: true, widows: true, zIndex: true, zoom: true}, cssProps: {"float": C.cssFloat ? "cssFloat" : "styleFloat"}, style: function (b7, b6, cd, b8) {
    ...
    bI.each(["height", "width"], function (b6, e) {
        bI.cssHooks[e] = {get: function (b8, b7, i) {
            if (b7) {
    ...
    if (!C.opacity) {
        bI.cssHooks.opacity = {get: function (i, e) {
            return aU.test((e && i.currentStyle ? i.currentStyle.filter : i.style.filter) || "") ? (0.01 * parseFloat(RegExp.$1)) + "" : e ? "1" : ""
        }, set: function (b8, b9) {
            var b7 = b8.style, i = b8.currentStyle, e = bI.isNumeric(b9) ? "alpha(opacity=" + b9 * 100 + ")" : "", b6 = i && i.filter || b7.filter || "";
            b7.zoom = 1;
    ...
    bI.cssHooks.marginRight = a7(C.reliableMarginRight, function (i, e) {
        if (e) {
            return bI.swap(i, {display: "inline-block"}, F, [i, "marginRight"])
        }
    });
    bI.each({margin: "", padding: "", border: "Width"}, function (e, i) {
        bI.cssHooks[e + i] = {expand: function (b8) {
            var b7 = 0, b6 = {}, b9 = typeof b8 === "string" ? b8.split(" ") : [b8];
            for (; b7 < 4; b7++) {
    ...
    bI.Tween = I;
    I.prototype = {constructor: I, init: function (b7, i, b9, e, b8, b6) {
        this.elem = b7;
        this.prop = b9;
    ...
    I.propHooks = {_default: {get: function (i) {
        var e;
    ...
    bI.fx.step = {};
    var M, ae, bR = /^(?:toggle|show|hide)$/, bJ = new RegExp("^(?:([+-])=|)(" + aE + ")([a-z%]*)$", "i"), bP = /queueHooks$/, aG = [h], a2 = {"*": [function (e, ca) {
        var cc = this.createTween(e, ca), b8 = cc.cur(), b7 = bJ.exec(ca), cb = b7 && b7[3] || (bI.cssNumber[e] ? "" : "px"), i = (bI.cssNumber[e] || cb !== "px" && +b8) && bJ.exec(bI.css(cc.elem, e)), b6 = 1, b9 = 20;
        if (i && i[3] !== cb) {
            cb = cb || i[3];
            b7 = b7 || [];
            i = +b8 || 1;
    ...
    function h(b7, cd, e) {
        var b6, cf, ca, ci, cj, cg, cc, b9, b8 = this, ce = {}, i = b7.style, cb = b7.nodeType && R(b7), ch = bI._data(b7, "fxshow");
        if (!e.queue) {
    ...
    function f(b6, ca, cd) {
        var ce, e, b9 = 0, i = aG.length, cc = bI.Deferred().always(function () {
            delete b8.elem
        }), b8 = function () {
            if (e) {
                return false
        ...
        }, b7 = cc.promise({elem: b6, props: bI.extend({}, ca), opts: bI.extend(true, {specialEasing: {}}, cd), originalProperties: ca, originalOptions: cd, startTime: M || bn(), duration: cd.duration, tweens: [], createTween: function (ch, cf) {
    ...
    bI.Animation = bI.extend(f, {tweener: function (i, b8) {
        if (bI.isFunction(i)) {
            b8 = i;
            i = ["*"]
        } else {
    ...
    bI.speed = function (b6, b7, i) {
        var e = b6 && typeof b6 === "object" ? bI.extend({}, b6) : {complete: i || !i && b7 || bI.isFunction(b6) && b6, duration: b6, easing: i && b7 || b7 && !bI.isFunction(b7) && b7};
    ...
    bI.fn.extend({fadeTo: function (e, b7, b6, i) {
        return this.filter(R).css("opacity", 0).show().end().animate({opacity: b7}, e, b6, i)
    }, animate: function (ca, b7, b9, b8) {
        var b6 = bI.isEmptyObject(ca), e = bI.speed(b7, b9, b8), i = function () {
        ...
        return this.each(function () {
            var cb = true, b8 = b6 != null && b6 + "queueHooks", ca = bI.timers, b9 = bI._data(this);
            if (b8) {
                if (b9[b8] && b9[b8].stop) {
                    b7(b9[b8])
                }
        ...
        return this.each(function () {
            var b7, ca = bI._data(this), b6 = ca[e + "queue"], i = ca[e + "queueHooks"], b9 = bI.timers, b8 = b6 ? b6.length : 0;
            ca.finish = true;
            bI.queue(this, e, []);
            if (i && i.stop) {
    ...
    bI.each({slideDown: bH("show"), slideUp: bH("hide"), slideToggle: bH("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (e, i) {
    ...
    bI.extend({valHooks: {option: {get: function (e) {
    ...
    bI.each(["radio", "checkbox"], function () {
        bI.valHooks[this] = {set: function (e, i) {
            if (bI.isArray(i)) {
    ...
    bI.fn.extend({attr: function (e, i) {
    ...
    bI.extend({attr: function (b8, b7, b9) {
    ...
    if (!bF || !bN) {
        bI.attrHooks.value = {set: function (i, b6, e) {
    ...
    if (!bN) {
        ...
        bI.valHooks.button = {get: function (b6, i) {
            var e = b6.getAttributeNode(i);
            if (e && e.specified) {
                return e.value
            }
        }, set: ba.set};
        bI.attrHooks.contenteditable = {set: function (i, b6, e) {
            ba.set(i, b6 === "" ? false : b6, e)
        }};
        bI.each(["width", "height"], function (b6, e) {
            bI.attrHooks[e] = {set: function (i, b7) {
                if (b7 === "") {
    ...
    if (!C.style) {
        bI.attrHooks.style = {get: function (e) {
    ...
    bI.fn.extend({prop: function (e, i) {
    ...
    bI.extend({propFix: {"for": "htmlFor", "class": "className"}, prop: function (b9, b7, ca) {
    ...
    if (!C.hrefNormalized) {
        bI.each(["href", "src"], function (b6, e) {
            bI.propHooks[e] = {get: function (i) {
                return i.getAttribute(e, 4)
            }}
        })
    }
    if (!C.optSelected) {
        bI.propHooks.selected = {get: function (i) {
            var e = i.parentNode;
            if (e) {
                e.selectedIndex;
                if (e.parentNode) {
    ...
    var bL = /[\t\r\n\f]/g;
    bI.fn.extend({addClass: function (cd) {
        ...
        return this.each(function () {
            if (i === "string") {
                var b9, b8 = 0, b7 = bI(this), ca = b6.match(aF) || [];
                while ((b9 = ca[b8++])) {
                    if (b7.hasClass(b9)) {
                        b7.removeClass(b9)
                    } else {
    ...
    bI.fn.extend({hover: function (e, i) {
    ...
    function ag(cg, b8, cd, b6) {
        var i, cb, ce, b9, b7, cf = {}, cc = cg.dataTypes.slice();
        if (cc[1]) {
                        ...
                        if (ce !== true) {
                            if (ce && cg["throws"]) {
                                ...
                                try {
                                    ...
                                    return{state: "parsererror", error: ce ? ca : "No conversion from " + b7 + " to " + cb}
                                }
                            }
                        }
                    }
    ...
    bI.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: aa, type: "GET", isLocal: B.test(b4[1]), global: true, processData: true, async: true, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": aX, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": true, "text json": bI.parseJSON, "text xml": bI.parseXML}, flatOptions: {url: true, context: true}}, ajaxSetup: function (i, e) {
        return e ? s(s(i, bI.ajaxSettings), e) : s(bI.ajaxSettings, i)
    }, ajaxPrefilter: bK(v), ajaxTransport: bK(a9), ajax: function (ca, b7) {
        if (typeof ca === "object") {
            b7 = ca;
            ca = undefined
        }
        b7 = b7 || {};
        var cj, cl, cb, cq, cf, b6, cm, b8, ce = bI.ajaxSetup({}, b7), cs = ce.context || ce, ch = ce.context && (cs.nodeType || cs.jquery) ? bI(cs) : bI.event, cr = bI.Deferred(), co = bI.Callbacks("once memory"), cc = ce.statusCode || {}, ci = {}, cp = {}, b9 = 0, cd = "canceled", ck = {readyState: 0, getResponseHeader: function (i) {
            var e;
            if (b9 === 2) {
                if (!b8) {
                    b8 = {};
    ...
    bI._evalUrl = function (e) {
        return bI.ajax({url: e, type: "GET", dataType: "script", async: false, global: false, "throws": true})
    };
    bI.fn.extend({wrapAll: function (e) {
        if (bI.isFunction(e)) {
    ...
    bI.fn.extend({serialize: function () {
        ...
        return this.map(function () {
            ...
            return b7 == null ? null : bI.isArray(b7) ? bI.map(b7, function (i) {
                return{name: b6.name, value: i.replace(W, "\r\n")}
    ...
    bI.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /(?:java|ecma)script/}, converters: {"text script": function (e) {
        bI.globalEval(e);
        return e
    }}});
    ...
    var bs = [], a8 = /(=)\?(?=&|$)|\?\?/;
    bI.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
    ...
    bI.fn.load = function (b7, ca, cb) {
        ...
        if (i.length > 0) {
            bI.ajax({url: b7, type: b8, dataType: "html", data: ca}).done(function (cc) {
                b6 = arguments;
    ...
    bI.offset = {setOffset: function (b7, ch, cb) {
    ...
    bI.fn.extend({offset: function (i) {
        if (arguments.length) {
    ...
    bI.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function (b6, i) {
        var e = /Y/.test(i);
    ...
    bI.each({Height: "height", Width: "width"}, function (e, i) {
        bI.each({padding: "inner" + e, content: i, "": "outer" + e}, function (b6, b7) {
            bI.fn[b7] = function (cb, ca) {
                var b9 = arguments.length && (b6 || typeof cb !== "boolean"), b8 = b6 || (cb === true || ca === true ? "margin" : "border");
...
(function (s, p, i) {
    ...
    var q, E, z = s.fn.init, A = s.parseJSON, v = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
    s.fn.init = function (G, J, I) {
        var H;
        if (G && typeof G === "string" && !s.isPlainObject(J) && (H = v.exec(s.trim(G))) && H[0]) {
            if (G.charAt(0) !== "<") {
            ...
            if (s.parseHTML) {
                return z.call(this, s.parseHTML(H[2], J, true), J, I)
            }
        }
...
(function (g, d) {
    ...
    var f = 0, b = /^ui-id-\d+$/;
    g.ui = g.ui || {}, g.extend(g.ui, {version: "1.10.4", keyCode: {BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106, NUMPAD_SUBTRACT: 109, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38}}), g.fn.extend({focus: function (a) {
        return function (e, j) {
    ...
    }}), g.extend(g.expr[":"], {data: g.expr.createPseudo ? g.expr.createPseudo(function (a) {
        return function (e) {
            return !!g.data(e, a)
        }
    }) : function (e, a, j) {
        ...
        var i = g.attr(a, "tabindex"), e = isNaN(i);
        return(e || i >= 0) && c(a, !e)
    ...
    }}), g.extend(g.ui, {plugin: {add: function (k, j, m) {
...
(function (b, d) {
    var a = 0, c = Array.prototype.slice, f = b.cleanData;
    b.cleanData = function (j) {
        ...
        m = m.split(".")[1], g = q + "-" + m, j || (j = u, u = b.Widget), b.expr[":"][g.toLowerCase()] = function (h) {
        ...
        }, b.extend(e, t, {version: j.version, _proto: b.extend({}, j), _childConstructors: []}), p = new u, p.options = b.widget.extend({}, p.options), b.each(j, function (h, l) {
            return b.isFunction(l) ? (k[h] = function () {
                ...
                return function () {
                    var r, v = this._super, w = this._superApply;
                    return this._super = i, this._superApply = n, r = l.apply(this, arguments), this._super = v, this._superApply = w, r
                }
            }(), d) : (k[h] = l, d)
        }), e.prototype = b.widget.extend(p, {widgetEventPrefix: t ? p.widgetEventPrefix || m : m}, k, {constructor: e, namespace: q, widgetName: m, widgetFullName: g}), t ? (b.each(t._childConstructors, function (n, h) {
            var l = h.prototype;
        ...
        b.fn[e] = function (j) {
            var m = "string" == typeof j, k = c.call(arguments, 1), i = this;
    ...
    }, b.Widget._childConstructors = [], b.Widget.prototype = {widgetName: "widget", widgetEventPrefix: "", defaultElement: "<div>", options: {disabled: !1, create: null}, _createWidget: function (h, g) {
        g = b(g || this.defaultElement || this)[0], this.element = b(g), this.uuid = a++, this.eventNamespace = "." + this.widgetName + this.uuid, this.options = b.widget.extend({}, this.options, this._getCreateOptions(), h), this.bindings = b(), this.hoverable = b(), this.focusable = b(), g !== this && (b.data(g, this.widgetFullName, this), this._on(!0, this.element, {remove: function (e) {
    ...
    }}, b.each({show: "fadeIn", hide: "fadeOut"}, function (h, g) {
        b.Widget.prototype["_" + h] = function (i, l, k) {
            "string" == typeof l && (l = {effect: l});
            var e, j = l ? l === !0 || "number" == typeof l ? g : l.effect || g : h;
            l = l || {}, "number" == typeof l && (l = {duration: l}), e = !b.isEmptyObject(l), l.complete = k, l.delay && i.delay(l.delay), e && b.effects && b.effects.effect[j] ? i[h](l) : j !== h && i[j] ? i[j](l.duration, l.easing, k) : i.queue(function (m) {
...
(function (a) {
    ...
    a(document).mouseup(function () {
        b = !1
    }), a.widget("ui.mouse", {version: "1.10.4", options: {cancel: "input,textarea,button,select,option", distance: 1, delay: 0}, _mouseInit: function () {
        var c = this;
...
(function (C, x) {
    ...
    C.position = {scrollbarWidth: function () {
        ...
        var d = h.isWindow || h.isDocument ? "" : h.element.css("overflow-x"), f = h.isWindow || h.isDocument ? "" : h.element.css("overflow-y"), l = "scroll" === d || "auto" === d && h.width < h.element[0].scrollWidth, c = "scroll" === f || "auto" === f && h.height < h.element[0].scrollHeight;
        return{width: c ? C.position.scrollbarWidth() : 0, height: l ? C.position.scrollbarWidth() : 0}
    }, getWithinInfo: function (d) {
        var a = C(d || window), c = C.isWindow(a[0]), f = !!a[0] && 9 === a[0].nodeType;
        ...
        l = C.extend({}, l);
        var r, d, i, f, u, t, o = C(l.of), n = C.position.getWithinInfo(l.within), h = C.position.getScrollInfo(n), s = (l.collision || "flip").split(" "), c = {};
        return t = k(o), o[0].preventDefault && (l.at = "left top"), d = t.width, i = t.height, f = t.offset, u = C.extend({}, f), C.each(["my", "at"], function () {
            ...
            var e, E, I = C(this), L = I.outerWidth(), H = I.outerHeight(), F = D(this, "marginLeft"), K = D(this, "marginTop"), J = L + F + D(this, "marginRight") + h.width, a = H + K + D(this, "marginBottom") + h.height, G = C.extend({}, u), p = q(c.my, I.outerWidth(), I.outerHeight());
            "right" === l.my[0] ? G.left -= L : "center" === l.my[0] && (G.left -= L / 2), "bottom" === l.my[1] ? G.top -= H : "center" === l.my[1] && (G.top -= H / 2), G.left += p[0], G.top += p[1], C.support.offsetFractions || (G.left = m(G.left), G.top = m(G.top)), e = {marginLeft: F, marginTop: K}, C.each(["left", "top"], function (M, N) {
                C.ui.position[s[M]] && C.ui.position[s[M]][N](G, {targetWidth: d, targetHeight: i, elemWidth: L, elemHeight: H, collisionPosition: e, collisionWidth: J, collisionHeight: a, offset: [r[0] + p[0], r[1] + p[1]], my: l.my, at: l.at, within: n, elem: I})
            }), l.using && (E = function (P) {
                var O = f.left - G.left, Q = O + d - L, R = f.top - G.top, N = R + i - H, M = {target: {element: o, left: f.left, top: f.top, width: d, height: i}, element: {element: I, left: G.left, top: G.top, width: L, height: H}, horizontal: 0 > Q ? "left" : O > 0 ? "right" : "center", vertical: 0 > N ? "top" : R > 0 ? "bottom" : "middle"};
    ...
    }, C.ui.position = {fit: {left: function (F, u) {
        var o, G = u.within, d = G.isWindow ? G.scrollLeft : G.offset.left, E = G.width, c = F.left - u.collisionPosition.marginLeft, f = d - c, p = c + u.collisionWidth - E - d;
        ...
        var o, G = u.within, d = G.isWindow ? G.scrollTop : G.offset.top, E = u.within.height, c = F.top - u.collisionPosition.marginTop, f = d - c, p = c + u.collisionHeight - E - d;
    ...
    }}, flip: {left: function (P, K) {
        var H, Q, F = K.within, N = F.offset.left + F.scrollLeft, E = F.width, G = F.isWindow ? F.scrollLeft : F.offset.left, I = P.left - K.collisionPosition.marginLeft, M = I - G, O = I + K.collisionWidth - E - G, L = "left" === K.my[0] ? -K.elemWidth : "right" === K.my[0] ? K.elemWidth : 0, r = "left" === K.at[0] ? K.targetWidth : "right" === K.at[0] ? -K.targetWidth : 0, J = -2 * K.offset[0];
        ...
        var H, R, F = L.within, O = F.offset.top + F.scrollTop, E = F.height, G = F.isWindow ? F.scrollTop : F.offset.top, I = Q.top - L.collisionPosition.marginTop, N = I - G, P = I + L.collisionHeight - E - G, M = "top" === L.my[1], r = M ? -L.elemHeight : "bottom" === L.my[1] ? L.elemHeight : 0, K = "top" === L.at[1] ? L.targetHeight : "bottom" === L.at[1] ? -L.targetHeight : 0, J = -2 * L.offset[1];
...
(function (a) {
    a.widget("ui.draggable", a.ui.mouse, {version: "1.10.4", widgetEventPrefix: "drag", options: {addClasses: !0, appendTo: "parent", axis: !1, connectToSortable: !1, containment: !1, cursor: "auto", cursorAt: !1, grid: !1, handle: !1, helper: "original", iframeFix: !1, opacity: !1, refreshPositions: !1, revert: !1, revertDuration: 500, scope: "default", scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, snap: !1, snapMode: "both", snapTolerance: 20, stack: !1, zIndex: !1, drag: null, start: null, stop: null}, _create: function () {
        ...
        var b = this.options, c = a.isFunction(b.helper) ? a(b.helper.apply(this.element[0], [d])) : "clone" === b.helper ? this.element.clone().removeAttr("id") : this.element;
        ...
        var g, p, d, m, c = this.options, b = "absolute" !== this.cssPosition || this.scrollParent[0] !== document && a.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, f = k.pageX, j = k.pageY;
    ...
    }}), a.ui.plugin.add("draggable", "connectToSortable", {start: function (f, c) {
        var d = a(this).data("ui-draggable"), g = d.options, b = a.extend({}, c, {item: d.element});
        d.sortables = [], a(g.connectToSortable).each(function () {
            var e = a.data(this, "ui-sortable");
            e && !e.options.disabled && (d.sortables.push({instance: e, shouldRevert: e.options.revert}), e.refreshPositions(), e._trigger("activate", f, b))
        })
    }, stop: function (d, b) {
        var c = a(this).data("ui-draggable"), f = a.extend({}, b, {item: c.element});
        ...
        var c = a(this).data("ui-draggable"), f = this;
        a.each(c.sortables, function () {
            var e = !1, g = this;
        ...
        var c = a("body"), b = a(this).data("ui-draggable").options;
        ...
        var c = a(b.helper), f = a(this).data("ui-draggable").options;
        ...
        var b = a(this).data("ui-draggable"), c = b.options, f = !1;
        ...
        var c = a(this).data("ui-draggable"), b = c.options;
        ...
        var q, y, J, x, t, A, C, H, k, G, w = a(this).data("ui-draggable"), D = w.options, E = D.snapTolerance, z = B.offset.left, K = z + w.helperProportions.width, j = B.offset.top, I = j + w.helperProportions.height;
        ...
        var d, b = this.data("ui-draggable").options, c = a.makeArray(a(b.stack)).sort(function (g, f) {
...
(function (a) {
    ...
    a.widget("ui.droppable", {version: "1.10.4", widgetEventPrefix: "drop", options: {accept: "*", activeClass: !1, addClasses: !0, greedy: !1, hoverClass: !1, scope: "default", tolerance: "intersect", activate: null, deactivate: null, drop: null, out: null, over: null}, _create: function () {
        var f, c = this.options, d = c.accept;
        this.isover = !1, this.isout = !0, this.accept = a.isFunction(d) ? d : function (e) {
            return e.is(d)
        }, this.proportions = function () {
            return arguments.length ? (f = arguments[0], undefined) : f ? f : f = {width: this.element[0].offsetWidth, height: this.element[0].offsetHeight}
        ...
        var d = c || a.ui.ddmanager.current, g = !1;
        ...
        var j, x, g = (z.positionAbs || z.position.absolute).left, e = (z.positionAbs || z.position.absolute).top, k = g + z.helperProportions.width, q = e + z.helperProportions.height, w = m.offset.left, y = m.offset.top, v = w + m.proportions().width, f = y + m.proportions().height;
        switch (A) {
            case"fit":
    ...
    }, a.ui.ddmanager = {current: null, droppables: {"default": []}, prepareOffsets: function (h, d) {
        var f, k, c = a.ui.ddmanager.droppables[h.options.scope] || [], j = d ? d.type : null, g = (h.currentItem || h.element).find(":data(ui-droppable)").addBack();
        a:for (f = 0; c.length > f; f++) {
            if (!(c[f].options.disabled || h && !c[f].accept.call(c[f].element[0], h.currentItem || h.element))) {
                ...
                c[f].visible = "none" !== c[f].element.css("display"), c[f].visible && ("mousedown" === j && c[f]._activate.call(c[f], d), c[f].offset = c[f].element.offset(), c[f].proportions({width: c[f].element[0].offsetWidth, height: c[f].element[0].offsetHeight}))
            }
        }
    }, drop: function (f, c) {
        var d = !1;
        ...
        d.options.refreshPositions && a.ui.ddmanager.prepareOffsets(d, c), a.each(a.ui.ddmanager.droppables[d.options.scope] || [], function () {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
                var f, i, e, h = a.ui.intersect(d, this, this.options.tolerance), g = !h && this.isover ? "isout" : h && !this.isover ? "isover" : null;
...
(function (b) {
    ...
    b.widget("ui.resizable", b.ui.mouse, {version: "1.10.4", widgetEventPrefix: "resize", options: {alsoResize: !1, animate: !1, animateDuration: "slow", animateEasing: "swing", aspectRatio: !1, autoHide: !1, containment: !1, ghost: !1, grid: !1, handles: "e,s,se", helper: !1, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 90, resize: null, start: null, stop: null}, _create: function () {
        ...
        if (this.element.addClass("ui-resizable"), b.extend(this, {_aspectRatio: !!h.aspectRatio, aspectRatio: h.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: h.helper || h.ghost || h.animate ? h.helper || "ui-resizable-helper" : null}), this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i) && (this.element.wrap(b("<div class='ui-wrapper' style='overflow: hidden;'></div>").css({position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"), left: this.element.css("left")})), this.element = this.element.parent().data("ui-resizable", this.element.data("ui-resizable")), this.elementIsWrapper = !0, this.element.css({marginLeft: this.originalElement.css("marginLeft"), marginTop: this.originalElement.css("marginTop"), marginRight: this.originalElement.css("marginRight"), marginBottom: this.originalElement.css("marginBottom")}), this.originalElement.css({marginLeft: 0, marginTop: 0, marginRight: 0, marginBottom: 0}), this.originalResizeStyle = this.originalElement.css("resize"), this.originalElement.css("resize", "none"), this._proportionallyResizeElements.push(this.originalElement.css({position: "static", zoom: 1, display: "block"})), this.originalElement.css({margin: this.originalElement.css("margin")}), this._proportionallyResize()), this.handles = h.handles || (b(".ui-resizable-handle", this.element).length ? {n: ".ui-resizable-n", e: ".ui-resizable-e", s: ".ui-resizable-s", w: ".ui-resizable-w", se: ".ui-resizable-se", sw: ".ui-resizable-sw", ne: ".ui-resizable-ne", nw: ".ui-resizable-nw"} : "e,s,se"), this.handles.constructor === String) {
            for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), j = this.handles.split(","), this.handles = {}, f = 0; j.length > f; f++) {
                g = b.trim(j[f]), d = "ui-resizable-" + g, l = b("<div class='ui-resizable-handle " + d + "'></div>"), l.css({zIndex: h.zIndex}), "se" === g && l.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[g] = ".ui-resizable-" + g, this.element.append(l)
            }
        }
        ...
        var q, A = this.helper, k = {}, y = this.originalMousePosition, j = this.axis, f = this.position.top, t = this.position.left, m = this.size.width, x = this.size.height, z = v.pageX - y.left || 0, w = v.pageY - y.top || 0, g = this._change[j];
        ...
        this.resizing = !1;
        var k, u, g, t, f, d, m, j = this.options, q = this;
        ...
        var g = this.position, f = this.size, h = this.axis;
        ...
        var k = this._vBoundaries, w = this.axis, g = a(v.width) && k.maxWidth && k.maxWidth < v.width, p = a(v.height) && k.maxHeight && k.maxHeight < v.height, f = a(v.width) && k.minWidth && k.minWidth > v.width, d = a(v.height) && k.minHeight && k.minHeight > v.height, j = this.originalPosition.left + this.originalSize.width, i = this.position.top + this.size.height, m = /sw|nw|w/.test(w), q = /nw|ne|n/.test(w);
        ...
        var f = this.element, d = this.options;
        ...
        var d = this.originalSize, g = this.originalPosition;
        return{left: g.left + h, width: d.width - h}
    }, n: function (f, h, d) {
        var g = this.originalSize, j = this.originalPosition;
    ...
    }}), b.ui.plugin.add("resizable", "animate", {stop: function (p) {
        ...
        k.element.animate(b.extend(m, q && j ? {top: q, left: j} : {}), {duration: u.animateDuration, easing: u.animateEasing, step: function () {
        ...
        var m, y, j, w, g, e, q, k = b(this).data("ui-resizable"), v = k.options, x = k.element, t = v.containment, f = t instanceof b ? t.get(0) : /parent/.test(t) ? x.parent().get(0) : t;
        f && (k.containerElement = b(f), /document/.test(t) || t === document ? (k.containerOffset = {left: 0, top: 0}, k.containerPosition = {left: 0, top: 0}, k.parentData = {element: b(document), left: 0, top: 0, width: b(document).width(), height: b(document).height() || document.body.parentNode.scrollHeight}) : (m = b(f), y = [], b(["Top", "Right", "Left", "Bottom"]).each(function (d, h) {
        ...
        var m, y, j, w, g = b(this).data("ui-resizable"), f = g.options, p = g.containerOffset, k = g.position, v = g._aspectRatio || q.shiftKey, x = {top: 0, left: 0}, t = g.containerElement;
        ...
        var p = b(this).data("ui-resizable"), k = p.options, t = p.containerOffset, g = p.containerPosition, q = p.containerElement, f = b(p.helper), d = f.offset(), m = f.outerWidth() - p.sizeDiff.width, j = f.outerHeight() - p.sizeDiff.height;
        ...
        var g = b(this).data("ui-resizable"), d = g.options, f = function (h) {
            b(h).each(function () {
                var i = b(this);
        ...
        var j = b(this).data("ui-resizable"), p = j.options, d = j.originalSize, m = j.originalPosition, k = {height: j.size.height - d.height || 0, width: j.size.width - d.width || 0, top: j.position.top - m.top || 0, left: j.position.left - m.left || 0}, g = function (i, h) {
            b(i).each(function () {
                var r = b(this), t = b(this).data("ui-resizable-alsoresize"), q = {}, s = h && h.length ? h : r.parents(f.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
        ...
        var g = b(this).data("ui-resizable"), d = g.options, f = g.size;
...
(function (a) {
    a.widget("ui.selectable", a.ui.mouse, {version: "1.10.4", options: {appendTo: "body", autoRefresh: !0, distance: 0, filter: "*", tolerance: "touch", selected: null, selecting: null, start: null, stop: null, unselected: null, unselecting: null}, _create: function () {
        var c, b = this;
        this.element.addClass("ui-selectable"), this.dragged = !1, this.refresh = function () {
            c = a(b.options.filter, b.element[0]), c.addClass("ui-selectee"), c.each(function () {
                var f = a(this), d = f.offset();
        ...
        this.opos = [d.pageX, d.pageY], this.options.disabled || (this.selectees = a(c.filter, this.element[0]), this._trigger("start", d), a(c.appendTo).append(this.helper), this.helper.css({left: d.pageX, top: d.pageY, width: 0, height: 0}), c.autoRefresh && this.refresh(), this.selectees.filter(".ui-selected").each(function () {
...
(function (b) {
    ...
    b.widget("ui.sortable", b.ui.mouse, {version: "1.10.4", widgetEventPrefix: "sort", ready: !1, options: {appendTo: "parent", axis: !1, connectWith: !1, containment: !1, cursor: "auto", cursorAt: !1, dropOnEmpty: !0, forcePlaceholderSize: !1, forceHelperSize: !1, grid: !1, handle: !1, helper: "original", items: "> *", opacity: !1, placeholder: !1, revert: !1, scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1000, activate: null, beforeStop: null, change: null, deactivate: null, out: null, over: null, receive: null, remove: null, sort: null, start: null, stop: null, update: null}, _create: function () {
        ...
        var f, g, l, k, d = this.options, h = !1;
        ...
        if (h) {
            if (b.ui.ddmanager && !this.options.dropBehaviour && b.ui.ddmanager.drop(this, h), this.options.revert) {
                var g = this, k = this.placeholder.offset(), j = this.options.axis, d = {};
        ...
        var d = this._getItemsAsjQuery(g && g.connected), f = [];
        ...
        var w = this.positionAbs.left, q = w + this.helperProportions.width, C = this.positionAbs.top, k = C + this.helperProportions.height, j = B.left, z = j + B.width, f = B.top, v = f + B.height, m = this.offset.click.top, y = this.offset.click.left, A = "x" === this.options.axis || C + m > f && v > C + m, x = "y" === this.options.axis || w + y > j && z > w + y, g = A && x;
        ...
        var e = "x" === this.options.axis || c(this.positionAbs.top + this.offset.click.top, f.top, f.height), g = "y" === this.options.axis || c(this.positionAbs.left + this.offset.click.left, f.left, f.width), j = e && g, h = this._getDragVerticalDirection(), d = this._getDragHorizontalDirection();
        return j ? this.floating ? d && "right" === d || "down" === h ? 2 : 1 : h && ("down" === h ? 2 : 1) : !1
    }, _intersectsWithSides: function (e) {
        var d = c(this.positionAbs.top + this.offset.click.top, e.top + e.height / 2, e.height), f = c(this.positionAbs.left + this.offset.click.left, e.left + e.width / 2, e.width), h = this._getDragVerticalDirection(), g = this._getDragHorizontalDirection();
        ...
        for (m.push([b.isFunction(this.options.items) ? this.options.items.call(this.element, null, {options: this.options, item: this.currentItem}) : b(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), t = m.length - 1; t >= 0; t--) {
            m[t][0].each(k)
        }
        return b(d)
        ...
        var m, y, j, g, w, f, p, k, v = this.items, x = [
            [b.isFunction(this.options.items) ? this.options.items.call(this.element[0], q, {item: this.currentItem}) : b(this.options.items, this.element), this]
        ], t = this._connectWith();
        if (t && this.ready) {
            for (m = t.length - 1; m >= 0; m--) {
                for (j = b(t[m]), y = j.length - 1; y >= 0; y--) {
                    g = b.data(j[y], this.widgetFullName), g && g !== this && !g.options.disabled && (x.push([b.isFunction(g.options.items) ? g.options.items.call(g.element[0], q, {item: this.currentItem}) : b(g.options.items, g.element), g]), this.containers.push(g))
                }
            }
        }
        for (m = x.length - 1; m >= 0; m--) {
            for (w = x[m][1], f = x[m][0], y = 0, k = f.length; k > y; y++) {
                p = b(f[y]), p.data(this.widgetName + "-item", w), v.push({item: p, instance: w, width: 0, height: 0, left: 0, top: 0})
            }
        }
        ...
        f.placeholder && f.placeholder.constructor !== String || (d = f.placeholder, f.placeholder = {element: function () {
            var e = g.currentItem[0].nodeName.toLowerCase(), h = b("<" + e + ">", g.document[0]).addClass(d || g.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper");
        ...
        var k, j, y, e, q, m, x, z, w, i, v = null, t = null;
        for (k = this.containers.length - 1; k >= 0; k--) {
        ...
        var d = this.options, f = b.isFunction(d.helper) ? b(d.helper.apply(this.element[0], [g, this.currentItem])) : "clone" === d.helper ? this.currentItem.clone() : this.currentItem;
        ...
        "string" == typeof d && (d = d.split(" ")), b.isArray(d) && (d = {left: +d[0], top: +d[1] || 0}), "left" in d && (this.offset.click.left = d.left + this.margins.left), "right" in d && (this.offset.click.left = this.helperProportions.width - d.right + this.margins.left), "top" in d && (this.offset.click.top = d.top + this.margins.top), "bottom" in d && (this.offset.click.top = this.helperProportions.height - d.bottom + this.margins.top)
    }, _getParentOffset: function () {
        ...
        var f, j, p = this.options, m = l.pageX, d = l.pageY, k = "absolute" !== this.cssPosition || this.scrollParent[0] !== document && b.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, g = /(html|body)/i.test(k[0].tagName);
...
(function (f) {
    ...
    c.height = c.paddingTop = c.paddingBottom = c.borderTopWidth = c.borderBottomWidth = "hide", b.height = b.paddingTop = b.paddingBottom = b.borderTopWidth = b.borderBottomWidth = "show", f.widget("ui.accordion", {version: "1.10.4", options: {active: 0, animate: {}, collapsible: !1, event: "click", header: "> li > :first-child,> :not(li):even", heightStyle: "auto", icons: {activeHeader: "ui-icon-triangle-1-s", header: "ui-icon-triangle-1-e"}, activate: null, beforeActivate: null}, _create: function () {
        ...
        return{header: this.active, panel: this.active.length ? this.active.next() : f(), content: this.active.length ? this.active.next() : f()}
        ...
        if (!h.altKey && !h.ctrlKey) {
            var g = f.ui.keyCode, e = this.headers.length, j = this.headers.index(h.target), k = !1;
            switch (h.keyCode) {
                case g.RIGHT:
                case g.DOWN:
        ...
        var g, e = this.options, h = e.heightStyle, k = this.element.parent(), j = this.accordionId = "ui-accordion-" + (this.element.attr("id") || ++d);
        this.active = this._findActive(e.active).addClass("ui-accordion-header-active ui-state-active ui-corner-top").removeClass("ui-corner-all"), this.active.next().addClass("ui-accordion-content-active").show(), this.headers.attr("role", "tab").each(function (o) {
            var m = f(this), l = m.attr("id"), p = m.next(), q = p.attr("id");
        ...
        a !== this.active[0] && (a = a || this.active[0], this._eventHandler({target: a, currentTarget: a, preventDefault: f.noop}))
        ...
        var k = this.options, p = this.active, u = f(q.currentTarget), j = u[0] === p[0], e = j && k.collapsible, g = e ? f() : u.next(), l = p.next(), m = {oldHeader: p, oldPanel: l, newHeader: e ? f() : u, newPanel: g};
        ...
        var g = h.newPanel, e = this.prevShow.length ? this.prevShow : h.oldPanel;
        this.prevShow.add(this.prevHide).stop(!0, !0), this.prevShow = g, this.prevHide = e, this.options.animate ? this._animate(g, e, h) : (e.hide(), g.show(), this._toggleComplete(h)), e.attr({"aria-hidden": "true"}), e.prev().attr("aria-selected", "false"), g.length && e.length ? e.prev().attr({tabIndex: -1, "aria-expanded": "false"}) : g.length && this.headers.filter(function () {
            return 0 === f(this).attr("tabIndex")
        }).attr("tabIndex", -1), g.attr("aria-hidden", "false").prev().attr({"aria-selected": "true", tabIndex: 0, "aria-expanded": "true"})
    }, _animate: function (m, y, z) {
        var i, a, g, k = this, p = 0, q = m.length && (!y.length || m.index() < y.index()), j = this.options.animate || {}, x = q && j.down || j, w = function () {
            k._toggleComplete(z)
        };
        return"number" == typeof x && (g = x), "string" == typeof x && (a = x), a = a || x.easing || j.easing, g = g || x.duration || j.duration, y.length ? m.length ? (i = m.show().outerHeight(), y.animate(c, {duration: g, easing: a, step: function (l, h) {
            h.now = Math.round(l)
        }}), m.hide().animate(b, {duration: g, easing: a, complete: w, step: function (l, h) {
...
(function (a) {
    a.widget("ui.autocomplete", {version: "1.10.4", defaultElement: "<input>", options: {appendTo: null, autoFocus: !1, delay: 300, minLength: 1, position: {my: "left top", at: "left bottom", collision: "none"}, source: null, change: null, close: null, focus: null, open: null, response: null, search: null, select: null}, requestIndex: 0, pending: 0, _create: function () {
        var d, c, e, g = this.element[0].nodeName.toLowerCase(), b = "textarea" === g, f = "input" === g;
        this.isMultiLine = b ? !0 : f ? !1 : this.element.prop("isContentEditable"), this.valueMethod = this.element[b || f ? "val" : "text"], this.isNewMenu = !0, this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off"), this._on(this.element, {keydown: function (i) {
        ...
        }}), this._initSource(), this.menu = a("<ul>").addClass("ui-autocomplete ui-front").appendTo(this._appendTo()).menu({role: null}).hide().data("ui-menu"), this._on(this.menu.element, {mousedown: function (j) {
            ...
            !1 !== this._trigger("focus", j, {item: k}) ? j.originalEvent && /^key/.test(j.originalEvent.type) && this._value(k.value) : this.liveRegion.text(k.value)
        }, menuselect: function (l, j) {
            var h = j.item.data("ui-autocomplete-item"), k = this.previous;
            ...
            })), !1 !== this._trigger("select", l, {item: h}) && this._value(h.value), this.term = this._value(), this.close(l), this.selectedItem = h
        }}), this.liveRegion = a("<span>", {role: "status", "aria-live": "polite"}).addClass("ui-helper-hidden-accessible").insertBefore(this.element), this._on(this.window, {beforeunload: function () {
        ...
        a.isArray(this.options.source) ? (c = this.options.source, this.source = function (e, f) {
            ...
            d.xhr && d.xhr.abort(), d.xhr = a.ajax({url: b, data: e, dataType: "json", success: function (g) {
                f(g)
            }, error: function () {
                f([])
            }})
        ...
        this.pending++, this.element.addClass("ui-autocomplete-loading"), this.cancelSearch = !1, this.source({term: b}, this._response())
    }, _response: function () {
        ...
        b && (b = this._normalize(b)), this._trigger("response", null, {content: b}), !this.options.disabled && b && b.length && !this.cancelSearch ? (this._suggest(b), this._trigger("open")) : this._close()
    }, close: function (b) {
        ...
        this.previous !== this._value() && this._trigger("change", b, {item: this.selectedItem})
    ...
    }}), a.widget("ui.autocomplete", a.ui.autocomplete, {options: {messages: {noResults: "No search results.", results: function (b) {
...
(function (g) {
    var d, c = "ui-button ui-widget ui-state-default ui-corner-all", h = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", f = function () {
        var a = g(this);
        setTimeout(function () {
            a.find(":ui-button").button("refresh")
        }, 1)
    }, b = function (e) {
        var a = e.name, k = e.form, j = g([]);
        return a && (a = a.replace(/'/g, "\\'"), j = k ? g(k).find("[name='" + a + "']") : g("[name='" + a + "']", e.ownerDocument).filter(function () {
            return !this.form
        })), j
    };
    g.widget("ui.button", {version: "1.10.4", defaultElement: "<button>", options: {disabled: null, text: !0, label: null, icons: {primary: null, secondary: null}}, _create: function () {
        ...
        var j = this, i = this.options, e = "checkbox" === this.type || "radio" === this.type, a = e ? "" : "ui-state-active";
        ...
        var k = this.buttonElement.removeClass(h), j = g("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(k.empty()).text(), l = this.options.icons, e = l.primary && l.secondary, m = [];
...
(function (h, d) {
    ...
    h.extend(h.ui, {datepicker: {version: "1.10.4"}});
    var j, g = "datepicker";
    h.extend(c.prototype, {markerClassName: "hasDatepicker", maxRows: 4, _widgetDatepicker: function () {
        return this.dpDiv
        ...
        return{id: k, input: e, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: a, dpDiv: a ? b(h("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv}
        ...
        if (this._get(q, "autoSize") && !q.inline) {
            var m, l, k, o, u = new Date(2009, 11, 20), p = this._get(q, "dateFormat");
        ...
        var k, e, m = h(l), o = h.data(l, g);
        m.hasClass(this.markerClassName) && (k = l.nodeName.toLowerCase(), "input" === k ? (l.disabled = !1, o.trigger.filter("button").each(function () {
            this.disabled = !1
        }).end().filter("img").css({opacity: "1.0", cursor: ""})) : ("div" === k || "span" === k) && (e = m.children("." + this._inlineClass), e.children().removeClass("ui-state-disabled"), e.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)), this._disabledInputs = h.map(this._disabledInputs, function (a) {
            return a === l ? null : a
        }))
        ...
        m.hasClass(this.markerClassName) && (k = l.nodeName.toLowerCase(), "input" === k ? (l.disabled = !0, o.trigger.filter("button").each(function () {
            this.disabled = !0
        }).end().filter("img").css({opacity: "0.5", cursor: "default"})) : ("div" === k || "span" === k) && (e = m.children("." + this._inlineClass), e.children().addClass("ui-state-disabled"), e.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)), this._disabledInputs = h.map(this._disabledInputs, function (a) {
            return a === l ? null : a
        ...
        var k, e, m, u = h.datepicker._getInst(l.target), p = !0, q = u.dpDiv.is(".ui-datepicker-rtl");
        ...
        var k, e = this._getNumberOfMonths(l), m = e[1], n = 17;
        ...
        var x = w.dpDiv.outerWidth(), l = w.dpDiv.outerHeight(), e = w.input ? w.input.outerWidth() : 0, k = w.input ? w.input.outerHeight() : 0, v = document.documentElement.clientWidth + (q ? 0 : h(document).scrollLeft()), p = document.documentElement.clientHeight + (q ? 0 : h(document).scrollTop());
        ...
        if (h.datepicker._curInst) {
            var k = h(l.target), e = h.datepicker._getInst(k[0]);
        ...
        var k, e = h(l), m = this._getInst(e[0]);
        ...
        var e, m = h(l), o = this._getInst(m[0]);
        ...
        var G, C, F, z, Q = 0, L = (B ? B.shortYearCutoff : null) || this._defaults.shortYearCutoff, I = "string" != typeof L ? L : (new Date).getFullYear() % 100 + parseInt(L, 10), P = (B ? B.dayNamesShort : null) || this._defaults.dayNamesShort, E = (B ? B.dayNames : null) || this._defaults.dayNames, N = (B ? B.monthNamesShort : null) || this._defaults.monthNamesShort, H = (B ? B.monthNames : null) || this._defaults.monthNames, O = -1, T = -1, x = -1, J = -1, q = !1, R = function (i) {
            var a = K.length > G + 1 && K.charAt(G + 1) === i;
            return a && G++, a
        }, A = function (m) {
            var k = R(m), a = "@" === m ? 14 : "!" === m ? 20 : "y" === m && k ? 4 : "o" === m ? 3 : 2, l = RegExp("^\\d{1," + a + "}"), o = S.substring(Q).match(l);
            if (!o) {
                throw"Missing number at position " + Q
            }
            return Q += o[0].length, parseInt(o[0], 10)
        }, t = function (a, k, p) {
            var l = -1, m = h.map(R(a) ? p : k, function (n, i) {
                return[
                    [i, n]
                ]
            }).sort(function (n, i) {
        ...
        return z
    }, ATOM: "yy-mm-dd", COOKIE: "D, dd M yy", ISO_8601: "yy-mm-dd", RFC_822: "D, d M y", RFC_850: "DD, dd-M-y", RFC_1036: "D, d M y", RFC_1123: "D, d M yy", RFC_2822: "D, d M yy", RSS: "D, d M y", TICKS: "!", TIMESTAMP: "@", W3C: "yy-mm-dd", _ticksTo1970: 10000000 * 60 * 60 * 24 * (718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)), formatDate: function (x, C, v) {
        if (!C) {
            return""
        }
        var A, D = (v ? v.dayNamesShort : null) || this._defaults.dayNamesShort, p = (v ? v.dayNames : null) || this._defaults.dayNames, k = (v ? v.monthNamesShort : null) || this._defaults.monthNamesShort, m = (v ? v.monthNames : null) || this._defaults.monthNames, B = function (e) {
        ...
        if (u.input.val() !== u.lastVal) {
            var l = this._get(u, "dateFormat"), k = u.lastVal = u.input ? u.input.val() : null, p = this._getDefaultDate(u), w = p, q = this._getFormatConfig(u);
            try {
        ...
        var k = !m, o = q.selectedMonth, u = q.selectedYear, p = this._restrictMinMax(q, this._determineDate(q, m, new Date));
        ...
        var k = this._get(l, "stepMonths"), e = "#" + l.id.replace(/\\\\/g, "\\");
        ...
        var x, O, J, G, N, C, K, F, L = this._get(M, "changeMonth"), Q = this._get(M, "changeYear"), w = this._get(M, "showMonthAfterYear"), H = "<div class='ui-datepicker-title'>", q = "";
        if (E || !L) {
        ...
        var k = q.drawYear + ("Y" === l ? m : 0), o = q.drawMonth + ("M" === l ? m : 0), u = Math.min(q.selectedDay, this._getDaysInMonth(k, o)) + ("D" === l ? m : 0), p = this._restrictMinMax(q, this._daylightSavingAdjust(new Date(k, o, u)));
        ...
        var l = this._getMinMaxDate(o, "min"), k = this._getMinMaxDate(o, "max"), n = l && l > m ? l : m;
        return k && n > k ? k : n
        ...
        var o = this._getNumberOfMonths(p), q = this._daylightSavingAdjust(new Date(l, k + (0 > m ? m : o[0] * o[1]), 1));
        return 0 > m && q.setDate(this._getDaysInMonth(q.getFullYear(), q.getMonth())), this._isInRange(p, q)
    }, _isInRange: function (q, x) {
        var p, v, y = this._getMinMaxDate(q, "min"), m = this._getMinMaxDate(q, "max"), k = null, l = null, w = this._get(q, "yearRange");
...
(function (c) {
    var b = {buttons: !0, height: !0, maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0, width: !0}, a = {maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0};
    c.widget("ui.dialog", {version: "1.10.4", options: {appendTo: "body", autoOpen: !0, buttons: [], closeOnEscape: !0, closeText: "close", dialogClass: "", draggable: !0, hide: null, height: "auto", maxHeight: null, maxWidth: null, minHeight: 150, minWidth: 150, modal: !1, position: {my: "center", at: "center", of: window, collision: "fit", using: function (e) {
        ...
        function d() {
            var g = this.document[0].activeElement, f = this.uiDialog[0] === g || c.contains(this.uiDialog[0], g);
            f || this._focusTabbable()
        }

        e.preventDefault(), d.call(this), this._delay(d)
    }, _createWrapper: function () {
        this.uiDialog = c("<div>").addClass("ui-dialog ui-widget ui-widget-content ui-corner-all ui-front " + this.options.dialogClass).hide().attr({tabIndex: -1, role: "dialog"}).appendTo(this._appendTo()), this._on(this.uiDialog, {keydown: function (f) {
            ...
            if (f.keyCode === c.ui.keyCode.TAB) {
                var e = this.uiDialog.find(":tabbable"), d = e.filter(":first"), g = e.filter(":last");
        ...
        var d;
        this.uiDialogTitlebar = c("<div>").addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(this.uiDialog), this._on(this.uiDialogTitlebar, {mousedown: function (e) {
            c(e.target).closest(".ui-dialog-titlebar-close") || this.uiDialog.focus()
        }}), this.uiDialogTitlebarClose = c("<button type='button'></button>").button({label: this.options.closeText, icons: {primary: "ui-icon-closethick"}, text: !1}).addClass("ui-dialog-titlebar-close").appendTo(this.uiDialogTitlebar), this._on(this.uiDialogTitlebarClose, {click: function (f) {
        ...
        var e = this, d = this.options.buttons;
        return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), c.isEmptyObject(d) || c.isArray(d) && !d.length ? (this.uiDialog.removeClass("ui-dialog-buttons"), undefined) : (c.each(d, function (g, f) {
            var h, j;
            f = c.isFunction(f) ? {click: f, text: g} : f, f = c.extend({type: "button"}, f), h = f.click, f.click = function () {
                h.apply(e.element[0], arguments)
            }, j = {icons: f.icons, text: f.showText}, delete f.icons, delete f.showText, c("<button></button>", f).button(j).appendTo(e.uiButtonSet)
        ...
        this.uiDialog.draggable({cancel: ".ui-dialog-content, .ui-dialog-titlebar-close", handle: ".ui-dialog-titlebar", containment: "document", start: function (g, h) {
        ...
        var e = this, d = this.options, g = d.resizable, j = this.uiDialog.css("position"), h = "string" == typeof g ? g : "n,e,s,w,se,sw,ne,nw";
        this.uiDialog.resizable({cancel: ".ui-dialog-content", containment: "document", alsoResize: this.element, maxWidth: d.maxWidth, maxHeight: d.maxHeight, minWidth: d.minWidth, minHeight: this._minHeight(), handles: h, start: function (i, k) {
        ...
        if (this.options.modal) {
            var e = this, d = this.widgetFullName;
        ...
        var f, e = this.options.position, d = [], g = [0, 0];
        ...
        }), e = {my: d[0] + (0 > g[0] ? g[0] : "+" + g[0]) + " " + d[1] + (0 > g[1] ? g[1] : "+" + g[1]), at: d.join(" ")}), e = c.extend({}, c.ui.dialog.prototype.options.position, e)) : e = c.ui.dialog.prototype.options.position, f = this.uiDialog.is(":visible"), f || this.uiDialog.show(), this.uiDialog.position(e), f || this.uiDialog.hide()
    }})
})(jQuery);
(function (a) {
    a.widget("ui.menu", {version: "1.10.4", defaultElement: "<ul>", delay: 300, options: {icons: {submenu: "ui-icon-carat-1-e"}, menus: "ul", position: {my: "left top", at: "right top"}, role: "menu", blur: null, focus: null, select: null}, _create: function () {
        ...
        }, mouseleave: "collapseAll", "mouseleave .ui-menu": "collapseAll", focus: function (c, d) {
        ...
        this.element.toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length), c.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({role: this.options.role, "aria-hidden": "true", "aria-expanded": "false"}).each(function () {
            var g = a(this), f = g.prev("a"), h = a("<span>").addClass("ui-menu-icon ui-icon " + b).data("ui-menu-submenu-carat", !0);
            f.attr("aria-haspopup", "true").prepend(h), g.attr("aria-labelledby", f.attr("id"))
        }), d = c.add(this.element), d.children(":not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role", "presentation").children("a").uniqueId().addClass("ui-corner-all").attr({tabIndex: -1, role: this._itemRole()}), d.children(":not(.ui-menu-item)").each(function () {
            var f = a(this);
        ...
        c || clearTimeout(this.timer), this.active && (this.active.children("a").removeClass("ui-state-focus"), this.active = null, this._trigger("blur", b, {item: this.active}))
        ...
        var b = a.extend({of: this.active}, this.options.position);
...
(function (a, b) {
    a.widget("ui.progressbar", {version: "1.10.4", options: {max: 100, value: 0, change: null, complete: null}, min: 0, _create: function () {
...
(function (a) {
    var b = 5;
    a.widget("ui.slider", a.ui.mouse, {version: "1.10.4", widgetEventPrefix: "slide", options: {animate: !1, distance: 0, max: 100, min: 0, orientation: "horizontal", range: !1, step: 1, value: 0, values: null, change: null, slide: null, start: null, stop: null}, _create: function () {
        this._keySliding = !1, this._mouseSliding = !1, this._animateOff = !0, this._handleIndex = null, this._detectOrientation(), this._mouseInit(), this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget ui-widget-content ui-corner-all"), this._refresh(), this._setOption("disabled", this.options.disabled), this._animateOff = !1
    }, _refresh: function () {
        this._createRange(), this._createHandles(), this._setupEvents(), this._refreshValue()
    }, _createHandles: function () {
        var g, d, f = this.options, j = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), c = "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>", h = [];
        ...
        var k, w, g, t, f, d, j, m, v = this, q = this.options;
        return q.disabled ? !1 : (this.elementSize = {width: this.element.outerWidth(), height: this.element.outerHeight()}, this.elementOffset = this.element.offset(), k = {x: p.pageX, y: p.pageY}, w = this._normValueFromMouse(k), g = this._valueMax() - this._valueMin() + 1, this.handles.each(function (h) {
            var c = Math.abs(w - v.values(h));
            (g > c || g === c && (h === v._lastChangedValue || v.values(h) === q.min)) && (g = c, t = a(this), f = h)
        }), d = this._start(p, f), d === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = f, t.addClass("ui-state-active").focus(), j = t.offset(), m = !a(p.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = m ? {left: 0, top: 0} : {left: p.pageX - j.left - t.width() / 2, top: p.pageY - j.top - t.height() / 2 - (parseInt(t.css("borderTopWidth"), 10) || 0) - (parseInt(t.css("borderBottomWidth"), 10) || 0) + (parseInt(t.css("marginTop"), 10) || 0)}, this.handles.hasClass("ui-state-hover") || this._slide(p, f, w), this._animateOff = !0, !0))
    }, _mouseStart: function () {
        return !0
        ...
        var c = {handle: this.handles[f], value: this.value()};
...
(function (a) {
    ...
    a.widget("ui.spinner", {version: "1.10.4", defaultElement: "<input>", widgetEventPrefix: "spin", options: {culture: null, icons: {down: "ui-icon-triangle-1-s", up: "ui-icon-triangle-1-n"}, incremental: !0, max: null, min: null, numberFormat: null, page: 10, step: 1, change: null, spin: null, start: null, stop: null}, _create: function () {
...
(function (d, g) {
    ...
    var h = 0, b = /#.*$/;
    d.widget("ui.tabs", {version: "1.10.4", delay: 300, options: {active: null, collapsible: !1, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null}, _create: function () {
        ...
        var a = this.options.active, e = this.options.collapsible, j = location.hash.substring(1);
        ...
        var k = d(this.document[0].activeElement).closest("li"), l = this.tabs.index(k), e = !0;
        ...
        var j = this.options, a = this.tablist.children(":has(a[href])");
        ...
        this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role: "tab", tabIndex: -1}), this.anchors = this.tabs.map(function () {
            return d("a", this)[0]
        }).addClass("ui-tabs-anchor").attr({role: "presentation", tabIndex: -1}), this.panels = d(), this.anchors.each(function (k, t) {
            var j, q, p, m = d(t).uniqueId().attr("id"), e = d(t).closest("li"), s = e.attr("aria-controls");
        ...
        var q = this.options, x = this.active, m = d(u.currentTarget), w = m.closest("li"), k = w[0] === x[0], j = k && q.collapsible, t = j ? d() : this._getPanelForTab(w), p = x.length ? this._getPanelForTab(x) : d(), v = {oldTab: x, oldPanel: p, newTab: j ? d() : w, newPanel: t};
        ...
        }) : (k.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), m.hide(), t()), m.attr({"aria-expanded": "false", "aria-hidden": "true"}), k.oldTab.attr("aria-selected", "false"), q.length && m.length ? k.oldTab.attr("tabIndex", -1) : q.length && this.tabs.filter(function () {
        ...
        this.xhr && this.xhr.abort(), this.element.removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible"), this.tablist.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").removeAttr("role"), this.anchors.removeClass("ui-tabs-anchor").removeAttr("role").removeAttr("tabIndex").removeUniqueId(), this.tabs.add(this.panels).each(function () {
            ...
            var j = d(this), a = j.data("ui-tabs-aria-controls");
        ...
        p = this._getIndex(p);
        var s = this, j = this.tabs.eq(p), q = j.find(".ui-tabs-anchor"), m = this._getPanelForTab(j), l = {tab: j, panel: m};
        ...
        var l = this;
        return{url: k.attr("href"), beforeSend: function (m, i) {
            return l._trigger("beforeLoad", a, d.extend({jqXHR: m, ajaxSettings: i}, j))
        }}
...
(function (b) {
    ...
    function a(h) {
        var f = h.data("ui-tooltip-id"), g = (h.attr("aria-describedby") || "").split(/\s+/), j = b.inArray(f, g);
        -1 !== j && g.splice(j, 1), h.removeData("ui-tooltip-id"), g = b.trim(g.join(" ")), g ? h.attr("aria-describedby", g) : h.removeAttr("aria-describedby")
    }

    var c = 0;
    b.widget("ui.tooltip", {version: "1.10.4", options: {content: function () {
        ...
        var f = this, g = b(h ? h.target : this.element).closest(this.options.items);
        ...
        var f, h = this.options.content, l = this, k = j ? j.type : null;
        ...
        if (q) {
            ...
            k.is("[title]") && (g && "mouseover" === g.type ? k.attr("title", "") : k.removeAttr("title")), f = this._tooltip(k), d(k, f.attr("id")), f.find(".ui-tooltip-content").html(q), this.options.track && g && /^mouse/.test(g.type) ? (this._on(this.document, {mousemove: p}), p(g)) : f.position(b.extend({of: k}, this.options.position)), f.hide(), this._show(f, this.options.show), this.options.show && this.options.show.delay && (j = this.delayedShow = setInterval(function () {
                f.is(":visible") && (p(e.of), clearInterval(j))
            }, b.fx.interval)), this._trigger("open", g, {tooltip: f}), m = {keyup: function (l) {
        ...
        var f = this, i = b(g ? g.currentTarget : this.element), h = this._find(i);
        ...
        var f = "ui-tooltip-" + c++, h = b("<div>").attr({id: f, role: "tooltip"}).addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content " + (this.options.tooltipClass || ""));
    ...
    b.effects = {effect: {}}, function (D, y) {
        ...
        function E(d) {
            ...
            return d = d.toLowerCase(), x(q, function (p, n) {
                var F, u = n.re.exec(d), i = u && n.parse(u), s = n.space || "rgba";
        ...
        var B, k = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", g = /^([\-+])=\s*(\d+\.?\d*)/, q = [
        ...
        }, A = {rgba: {props: {red: {idx: 0, type: "byte"}, green: {idx: 1, type: "byte"}, blue: {idx: 2, type: "byte"}}}, hsla: {props: {hue: {idx: 0, type: "degrees"}, saturation: {idx: 1, type: "percent"}, lightness: {idx: 2, type: "percent"}}}}, C = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, z = w.support = {}, j = D("<p>")[0], x = D.each;
        j.style.cssText = "background-color:rgba(1,1,1,.5)", z.rgba = j.style.backgroundColor.indexOf("rgba") > -1, x(A, function (d, f) {
            f.cache = "_" + d, f.props.alpha = {idx: 3, type: "percent", def: 1}
        }), w.fn = D.extend(w.prototype, {parse: function (F, t, h, e) {
            if (F === y) {
                return this._rgba = [null, null, null, null], this
            }
            (F.jquery || F.nodeType) && (F = D(F).css(t), t = y);
            var f = this, s = D.type(F), i = this._rgba = [];
            ...
            var i = w(h), G = i._space(), f = A[G], F = 0 === this.alpha() ? w("transparent") : this, p = F[f.cache] || f.to(F._rgba), d = p.slice();
            return i = i[f.cache], x(f.props, function (l, I) {
                var e = I.idx, s = p[e], r = i[e], H = C[I.type] || {};
            ...
            var I, G, N = M[0] / 255, p = M[1] / 255, K = M[2] / 255, f = M[3], d = Math.max(N, p, K), F = Math.min(N, p, K), H = d - F, J = d + F, L = 0.5 * J;
            ...
            var p = h[0] / 360, f = h[1], l = h[2], d = h[3], u = 0.5 >= l ? l * (1 + f) : l + f - l * f, n = 2 * l - u;
            return[Math.round(255 * m(n, u, p + 1 / 3)), Math.round(255 * m(n, u, p)), Math.round(255 * m(n, u, p - 1 / 3)), d]
        }, x(A, function (f, p) {
            var e = p.props, h = p.cache, d = p.to, i = p.from;
            w.fn[f] = function (o) {
                if (d && !this[h] && (this[h] = d(this._rgba)), o === y) {
                    return this[h].slice()
                }
                var G, t = D.type(o), l = "array" === t || "object" === t ? o : arguments, F = this[h].slice();
                ...
                w.fn[n] || (w.fn[n] = function (G) {
                    var s, u = D.type(G), r = "alpha" === n ? this._hsla ? "hsla" : "rgba" : f, t = this[r](), F = t[l.idx];
            ...
            var d = f.split(" ");
            x(d, function (l, h) {
                D.cssHooks[h] = {set: function (t, F) {
                    var p, u, s = "";
                    if ("transparent" !== F && ("string" !== D.type(F) || (p = E(F)))) {
                        if (F = w(p || F), !z.rgba && 1 !== F._rgba[3]) {
                            for (u = "backgroundColor" === h ? t.parentNode : t; ("" === s || "transparent" === s) && u && u.style;) {
                                try {
        ...
        }, w.hook(k), D.cssHooks.borderColor = {expand: function (d) {
            var f = {};
        ...
        function e(l) {
            var j, k, m = l.ownerDocument.defaultView ? l.ownerDocument.defaultView.getComputedStyle(l, null) : l.currentStyle, h = {};
        ...
        b.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (j, h) {
            ...
            return this.queue(function () {
                var l, q = b(this), p = q.attr("class") || "", n = h.children ? q.find("*").addBack() : q;
                n = n.map(function () {
                    var o = b(this);
                    ...
                    var t = this, o = b.Deferred(), r = b.extend({}, h, {queue: !1, complete: function () {
                        o.resolve(t)
                    }});
        ...
        }, b.fn.extend({addClass: function (h) {
            return function (k, l, m, j) {
                return l ? b.effects.animateClass.call(this, {add: k}, l, m, j) : h.apply(this, arguments)
            }
        }(b.fn.addClass), removeClass: function (h) {
            return function (k, l, m, j) {
                return arguments.length > 1 ? b.effects.animateClass.call(this, {remove: k}, l, m, j) : h.apply(this, arguments)
            }
        }(b.fn.removeClass), toggleClass: function (h) {
            return function (j, m, i, l, k) {
                return"boolean" == typeof m || m === c ? i ? b.effects.animateClass.call(this, m ? {add: j} : {remove: j}, i, l, k) : h.apply(this, arguments) : b.effects.animateClass.call(this, {toggle: j}, m, i, l)
            }
        }(b.fn.toggleClass), switchClass: function (l, j, k, m, h) {
            return b.effects.animateClass.call(this, {add: j, remove: l}, k, m, h)
        }})
    }(), function () {
        function d(h, f, g, j) {
            return b.isPlainObject(h) && (f = h, h = h.effect), h = {effect: h}, null == f && (f = {}), b.isFunction(f) && (j = f, g = null, f = {}), ("number" == typeof f || b.fx.speeds[f]) && (j = g, g = f, f = {}), b.isFunction(g) && (j = g, g = null), f && b.extend(h, f), g = g || f.duration, h.duration = b.fx.off ? 0 : "number" == typeof g ? g : g in b.fx.speeds ? b.fx.speeds[g] : b.fx.speeds._default, h.complete = j || f.complete, h
        }
        ...
        b.extend(b.effects, {version: "1.10.4", save: function (f, h) {
            ...
            var g = {width: j.outerWidth(!0), height: j.outerHeight(!0), "float": j.css("float")}, h = b("<div></div>").addClass("ui-effects-wrapper").css({fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0}), l = {width: j.width(), height: j.height()}, f = document.activeElement;
            try {
                f.id
            } catch (k) {
                f = document.body
            }
            return j.wrap(h), (j[0] === f || b.contains(j[0], f)) && b(f).focus(), h = j.parent(), "static" === j.css("position") ? (h.css({position: "relative"}), j.css({position: "relative"})) : (b.extend(g, {position: j.css("position"), zIndex: j.css("z-index")}), b.each(["top", "left", "bottom", "right"], function (i, m) {
        ...
        }}), b.fn.extend({effect: function () {
            function h(o) {
                function l() {
                    b.isFunction(i) && i.call(p[0]), b.isFunction(o) && o()
                }

                var p = b(this), i = g.complete, m = g.mode;
                (p.is(":hidden") ? "hide" === m : "show" === m) ? (p[m](), l()) : j.call(p[0], g, l)
            }

            var g = d.apply(this, arguments), k = g.mode, f = g.queue, j = b.effects.effect[g.effect];
        ...
        }(b.fn.toggle), cssUnit: function (h) {
            var f = this.css(h), g = [];
        ...
        b.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (f, e) {
            ...
            for (var h, f = 4; ((h = Math.pow(2, --f)) - 1) / 11 > g;) {
            }
...
(function (b) {
    var c = /up|down|vertical/, a = /up|left|vertical|horizontal/;
    b.effects.effect.blind = function (E, k) {
        var B, j, e, t = b(this), w = ["position", "top", "bottom", "left", "right", "height", "width"], A = b.effects.setMode(t, E.mode || "hide"), D = E.direction || "up", z = c.test(D), i = z ? "height" : "width", y = z ? "top" : "left", x = a.test(D), q = {}, C = "show" === A;
...
(function (a) {
    a.effects.effect.bounce = function (H, D) {
        var t, A, L, z = a(this), w = ["position", "top", "bottom", "left", "right", "height", "width"], C = a.effects.setMode(z, H.mode || "effect"), E = "hide" === C, J = "show" === C, q = H.direction || "up", I = H.distance, x = H.times || 5, G = 2 * x + (J || E ? 1 : 0), F = H.duration / G, B = H.easing, k = "up" === q || "down" === q ? "top" : "left", M = "up" === q || "left" === q, K = z.queue(), j = K.length;
        for ((J || E) && w.push("opacity"), a.effects.save(z, w), z.show(), a.effects.createWrapper(z), I || (I = z["top" === k ? "outerHeight" : "outerWidth"]() / 3), J && (L = {opacity: 1}, L[k] = 0, z.css("opacity", 0).css(k, M ? 2 * -I : 2 * I).animate(L, F, B)), E && (I /= Math.pow(2, x - 1)), L = {}, L[k] = 0, t = 0; x > t; t++) {
            A = {}, A[k] = (M ? "-=" : "+=") + I, z.animate(A, F, B).animate(L, F, B), I = E ? 2 * I : I / 2
        }
        E && (A = {opacity: 0}, A[k] = (M ? "-=" : "+=") + I, z.animate(A, F, B)), z.queue(function () {
...
(function (a) {
    a.effects.effect.clip = function (w, q) {
        var B, k, z, j = a(this), b = ["position", "top", "bottom", "left", "right", "height", "width"], m = a.effects.setMode(j, w.mode || "hide"), t = "show" === m, y = w.direction || "vertical", A = "vertical" === y, x = A ? "height" : "width", g = A ? "top" : "left", v = {};
        a.effects.save(j, b), j.show(), B = a.effects.createWrapper(j).css({overflow: "hidden"}), k = "IMG" === j[0].tagName ? B : j, z = k[x](), t && (k.css(x, 0), k.css(g, z / 2)), v[x] = t ? z : 0, v[g] = t ? 0 : z / 2, k.animate(v, {queue: !1, duration: w.duration, easing: w.easing, complete: function () {
...
(function (a) {
    a.effects.effect.drop = function (m, j) {
        var v, f = a(this), q = ["position", "top", "bottom", "left", "right", "opacity", "height", "width"], d = a.effects.setMode(f, m.mode || "hide"), b = "show" === d, g = m.direction || "left", k = "up" === g || "down" === g ? "top" : "left", p = "up" === g || "left" === g ? "pos" : "neg", t = {opacity: b ? 1 : 0};
        a.effects.save(f, q), f.show(), a.effects.createWrapper(f), v = m.distance || f["top" === k ? "outerHeight" : "outerWidth"](!0) / 2, b && f.css("opacity", 0).css(k, "pos" === p ? -v : v), t[k] = (b ? "pos" === p ? "+=" : "-=" : "pos" === p ? "-=" : "+=") + v, f.animate(t, {queue: !1, duration: m.duration, easing: m.easing, complete: function () {
...
(function (a) {
    a.effects.effect.explode = function (F, B) {
        ...
        function y() {
            w.css({visibility: "visible"}), a(I).remove(), D || w.hide(), B()
        }

        var J, x, t, A, C, H, k = F.pieces ? Math.round(Math.sqrt(F.pieces)) : 3, G = k, w = a(this), E = a.effects.setMode(w, F.mode || "hide"), D = "show" === E, z = w.show().css("visibility", "hidden").offset(), j = Math.ceil(w.outerWidth() / G), K = Math.ceil(w.outerHeight() / k), I = [];
        for (J = 0; k > J; J++) {
...
(function (a) {
    a.effects.effect.fade = function (d, b) {
        var c = a(this), f = a.effects.setMode(c, d.mode || "toggle");
        c.animate({opacity: f}, {queue: !1, duration: d.duration, easing: d.easing, complete: b})
    }
})(jQuery);
(function (a) {
    a.effects.effect.fold = function (B, x) {
        var H, q, E = a(this), k = ["position", "top", "bottom", "left", "right", "height", "width"], b = a.effects.setMode(E, B.mode || "hide"), w = "show" === b, y = "hide" === b, D = B.size || 15, G = /([0-9]+)%/.exec(D), C = !!B.horizFirst, j = w !== C, A = j ? ["width", "height"] : ["height", "width"], z = B.duration / 2, t = {}, F = {};
        a.effects.save(E, k), E.show(), H = a.effects.createWrapper(E).css({overflow: "hidden"}), q = j ? [H.width(), H.height()] : [H.height(), H.width()], G && (D = parseInt(G[1], 10) / 100 * q[y ? 0 : 1]), w && H.css(C ? {height: 0, width: D} : {height: D, width: 0}), t[A[0]] = w ? q[0] : D, F[A[1]] = w ? q[1] : 0, H.animate(t, z, B.easing).animate(F, z, B.easing, function () {
...
(function (a) {
    a.effects.effect.highlight = function (f, c) {
        var d = a(this), h = ["backgroundImage", "backgroundColor", "opacity"], b = a.effects.setMode(d, f.mode || "show"), g = {backgroundColor: d.css("backgroundColor")};
        "hide" === b && (g.opacity = 0), a.effects.save(d, h), d.show().css({backgroundImage: "none", backgroundColor: f.color || "#ffff99"}).animate(g, {queue: !1, duration: f.duration, easing: f.easing, complete: function () {
...
(function (a) {
    a.effects.effect.pulsate = function (t, m) {
        var z, j = a(this), x = a.effects.setMode(j, t.mode || "show"), g = "show" === x, b = "hide" === x, k = g || "hide" === x, q = 2 * (t.times || 5) + (k ? 1 : 0), w = t.duration / q, y = 0, v = j.queue(), f = v.length;
        for ((g || !j.is(":visible")) && (j.css("opacity", 0).show(), y = 1), z = 1; q > z; z++) {
            j.animate({opacity: y}, w, t.easing), y = 1 - y
        }
        j.animate({opacity: y}, w, t.easing), j.queue(function () {
            b && j.hide(), m()
...
(function (a) {
    a.effects.effect.puff = function (h, d) {
        var f = a(this), k = a.effects.setMode(f, h.mode || "hide"), c = "hide" === k, j = parseInt(h.percent, 10) || 150, g = j / 100, b = {height: f.height(), width: f.width(), outerHeight: f.outerHeight(), outerWidth: f.outerWidth()};
        ...
        var t = a(this), f = a.extend(!0, {}, m), q = a.effects.setMode(t, m.mode || "effect"), d = parseInt(m.percent, 10) || (0 === parseInt(m.percent, 10) ? 0 : "hide" === q ? 0 : 100), b = m.direction || "both", g = m.origin, k = {height: t.height(), width: t.width(), outerHeight: t.outerHeight(), outerWidth: t.outerWidth()}, p = {y: "horizontal" !== b ? d / 100 : 1, x: "vertical" !== b ? d / 100 : 1};
        ...
        "show" === w && x.show(), q = {height: x.height(), width: x.width(), outerHeight: x.outerHeight(), outerWidth: x.outerWidth()}, "toggle" === F.mode && "show" === w ? (x.from = F.to || I, x.to = F.from || q) : (x.from = F.from || ("show" === w ? I : q), x.to = F.to || ("hide" === w ? I : q)), J = {from: {y: x.from.height / q.height, x: x.from.width / q.width}, to: {y: x.to.height / q.height, x: x.to.width / q.width}}, ("box" === D || "both" === D) && (J.from.y !== J.to.y && (K = K.concat(k), x.from = a.effects.setTransition(x, k, J.from.y, x.from), x.to = a.effects.setTransition(x, k, J.to.y, x.to)), J.from.x !== J.to.x && (K = K.concat(G), x.from = a.effects.setTransition(x, G, J.from.x, x.from), x.to = a.effects.setTransition(x, G, J.to.x, x.to))), ("content" === D || "both" === D) && J.from.y !== J.to.y && (K = K.concat(H).concat(C), x.from = a.effects.setTransition(x, H, J.from.y, x.from), x.to = a.effects.setTransition(x, H, J.to.y, x.to)), a.effects.save(x, K), x.show(), a.effects.createWrapper(x), x.css("overflow", "hidden").css(x.from), z && (y = a.effects.getBaseline(z, q), x.from.top = (q.outerHeight - x.outerHeight()) * y.y, x.from.left = (q.outerWidth - x.outerWidth()) * y.x, x.to.top = (q.outerHeight - x.to.outerHeight) * y.y, x.to.left = (q.outerWidth - x.to.outerWidth) * y.x), x.css(x.from), ("content" === D || "both" === D) && (k = k.concat(["marginTop", "marginBottom"]).concat(H), G = G.concat(["marginLeft", "marginRight"]), C = t.concat(k).concat(G), x.find("*[width]").each(function () {
            ...
            E && a.effects.save(b, C), b.from = {height: c.height * J.from.y, width: c.width * J.from.x, outerHeight: c.outerHeight * J.from.y, outerWidth: c.outerWidth * J.from.x}, b.to = {height: c.height * J.to.y, width: c.width * J.to.x, outerHeight: c.height * J.to.y, outerWidth: c.width * J.to.x}, J.from.y !== J.to.y && (b.from = a.effects.setTransition(b, k, J.from.y, b.from), b.to = a.effects.setTransition(b, k, J.to.y, b.to)), J.from.x !== J.to.x && (b.from = a.effects.setTransition(b, G, J.from.x, b.from), b.to = a.effects.setTransition(b, G, J.to.x, b.to)), b.css(b.from), b.animate(b.to, F.duration, F.easing, function () {
                E && a.effects.restore(b, C)
            })
        })), x.animate(x.to, {queue: !1, duration: F.duration, easing: F.easing, complete: function () {
            0 === x.to.opacity && x.css("opacity", x.from.opacity), "hide" === w && x.hide(), a.effects.restore(x, K), E || ("static" === j ? x.css({position: "relative", top: x.to.top, left: x.to.left}) : a.each(["top", "left"], function (b, c) {
                x.css(c, function (g, d) {
                    var f = parseInt(d, 10), h = b ? x.to.left : x.to.top;
...
(function (a) {
    a.effects.effect.shake = function (E, A) {
        var k, x = a(this), H = ["position", "top", "bottom", "left", "right", "height", "width"], w = a.effects.setMode(x, E.mode || "effect"), q = E.direction || "left", z = E.distance || 20, B = E.times || 3, G = 2 * B + 1, j = Math.round(E.duration / G), F = "up" === q || "down" === q ? "top" : "left", t = "up" === q || "left" === q, D = {}, C = {}, y = {}, b = x.queue(), I = b.length;
...
(function (a) {
    a.effects.effect.slide = function (m, j) {
        var v, f = a(this), q = ["position", "top", "bottom", "left", "right", "width", "height"], d = a.effects.setMode(f, m.mode || "show"), b = "show" === d, g = m.direction || "left", k = "up" === g || "down" === g ? "top" : "left", p = "up" === g || "left" === g, t = {};
        a.effects.save(f, q), f.show(), v = m.distance || f["top" === k ? "outerHeight" : "outerWidth"](!0), a.effects.createWrapper(f).css({overflow: "hidden"}), b && f.css(k, p ? isNaN(v) ? "-" + v : -v : v), t[k] = (b ? p ? "+=" : "-=" : p ? "-=" : "+=") + v, f.animate(t, {queue: !1, duration: m.duration, easing: m.easing, complete: function () {
            "hide" === d && f.hide(), a.effects.restore(f, q), a.effects.removeWrapper(f), j()
        }})
    }
})(jQuery);
...
if ($("body").data("page") != "image_croping" && $("body").data("page") != "widgets" && $("body").data("page") != "charts") {
    (function (a, c, b) {
        ...
        (function ($, i, f) {
            ...
            j = (function () {
                ...
                i.attachEvent && !i.addEventListener && !h && (function () {
                    ...
                    p = function (z, w) {
                        var y = u.document, x = $.fn[g].domain;
                        if (z !== w) {
                            y.title = l.title;
                            y.open();
        ...
        (function (f, e, g) {
            f.extend(f.mobile, {version: "1.4.2", subPageUrlKey: "", hideUrlBar: true, keepNative: ":jqmData(role='none'), :jqmData(role='nojs')", activePageClass: "page-active", activeBtnClass: "ui-btn-active", focusClass: "ui-focus", ajaxEnabled: false, hashListeningEnabled: true, linkBindingEnabled: false, defaultPageTransition: "fade", maxTransitionWidth: false, minScrollBack: 0, defaultDialogTransition: "pop", pageLoadErrorMessage: "Error Loading Page", pageLoadErrorMessageTheme: "a", phonegapNavigationEnabled: false, autoInitializePage: true, pushStateEnabled: true, ignoreContentEnabled: false, buttonMarkup: {hoverDelay: 200}, dynamicBaseEnabled: true, pageContainer: f(), allowCrossDomainPages: false, dialogHashKey: "&ui-state=dialog"})
        })(c, this);
        (function (j, h, k) {
            var g = {}, f = j.find, i = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/, e = /:jqmData\(([^)]*)\)/g;
            j.extend(j.mobile, {ns: "", getAttribute: function (m, l) {
                var o;
                m = m.jquery ? m[0] : m;
                if (m && m.getAttribute) {
                ...
                return o
            }, nsNormalizeDict: g, nsNormalize: function (l) {
        ...
        (function (f, j) {
            var e = 0, i = /^ui-id-\d+$/;
            f.ui = f.ui || {};
            f.extend(f.ui, {version: "c0ab71056b936627e8a7821f03c044aec6280a40", keyCode: {BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38}});
            f.fn.extend({focus: (function (k) {
                return function (l, m) {
            ...
            f.extend(f.expr[":"], {data: f.expr.createPseudo ? f.expr.createPseudo(function (k) {
                return function (l) {
                    return !!f.data(l, k)
                }
            }) : function (m, l, k) {
                ...
                var k = f.attr(m, "tabindex"), l = isNaN(k);
                return(l || k >= 0) && h(m, !l)
            }});
            if (!f("<a>").outerWidth(1).jquery) {
                f.each(["Width", "Height"], function (m, k) {
                    var l = k === "Width" ? ["Left", "Right"] : ["Top", "Bottom"], n = k.toLowerCase(), p = {innerWidth: f.fn.innerWidth, innerHeight: f.fn.innerHeight, outerWidth: f.fn.outerWidth, outerHeight: f.fn.outerHeight};
            ...
            f.ui.plugin = {add: function (l, m, o) {
        ...
        (function (g, f, h) {
            var e = function (n, m) {
                var i = n.parent(), p = [], j = i.children(":jqmData(role='header')"), l = n.children(":jqmData(role='header')"), o = i.children(":jqmData(role='footer')"), k = n.children(":jqmData(role='footer')");
            ...
            g.extend(g.mobile, {window: g(f), document: g(a), keyCode: g.ui.keyCode, behaviors: {}, silentScroll: function (i) {
                if (g.type(i) !== "number") {
                ...
                setTimeout(function () {
                    f.scrollTo(0, i);
                    g.mobile.document.trigger("silentscroll", {x: 0, y: i})
                }, 20);
                setTimeout(function () {
                    g.event.special.scrollstart.enabled = true
                }, 150)
            }, getClosestBaseUrl: function (k) {
                var i = g(k).closest(".ui-page").jqmData("url"), j = g.mobile.path.documentBase.hrefNoHash;
                ...
                var l = g("." + g.mobile.activePageClass), k = l.height(), j = l.outerHeight(true);
                i = e(l, (typeof i === "number") ? i : g.mobile.getScreenHeight());
                l.css("min-height", i - (j - k))
            }, loading: function () {
                var i = this.loading._widget || g(g.mobile.loader.prototype.defaultHtml).loader(), j = i.loader.apply(i, arguments);
                this.loading._widget = i;
                return j
            }});
            g.addDependents = function (j, k) {
                var i = g(j), l = i.jqmData("dependents") || g();
                i.jqmData("dependents", g(l).add(k))
            };
            g.fn.extend({removeWithDependents: function () {
            ...
            g.addDependents = function (k, j) {
                var i = g(k), l = i.jqmData("dependents") || g();
        ...
        (function (f, g) {
            var e = {touch: "ontouchend" in a};
            f.mobile.support = f.mobile.support || {};
            f.extend(f.support, e);
            f.extend(f.mobile.support, e)
        }(c));
        (function (e, f) {
            e.extend(e.support, {orientation: "orientation" in b && "onorientationchange" in b})
        }(c));
        (function (k, h) {
            function g(y) {
            ...
            function l() {
                var u = b, x = !!u.document.createElementNS && !!u.document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect && !(u.opera && navigator.userAgent.indexOf("Chrome") === -1), y = function (w) {
                    if (!(w && x)) {
            ...
            function f() {
                ...
                if (!x.length) {
                    x = z = k("<base>", {href: y}).appendTo("head")
                } else {
                    u = x.attr("href")
                }
            ...
            k.extend(k.mobile, {browser: {}});
            k.mobile.browser.oldIE = (function () {
                var w = 3, x = a.createElement("div"), u = x.all || [];
                do {
            ...
            function m() {
                var D = b, v = navigator.userAgent, y = navigator.platform, C = v.match(/AppleWebKit\/([0-9]+)/), B = !!C && C[1], x = v.match(/Fennec\/([0-9]+)/), z = !!x && x[1], A = v.match(/Opera Mobi\/([0-9]+)/), u = !!A && A[1];
        ...
        (function (g, h) {
            ...
            g.event.special.beforenavigate = {setup: function () {
                i.on("navigate", e)
            }, teardown: function () {
                i.off("navigate", e)
            }};
            g.event.special.navigate = f = {bound: false, pushStateEnabled: true, originalEventName: h, isPushStateEnabled: function () {
                ...
                var l = new g.Event("navigate"), m = new g.Event("beforenavigate"), k = j.originalEvent.state || {};
                m.originalEvent = j;
                i.trigger(m);
                ...
                var k = new g.Event("navigate"), l = new g.Event("beforenavigate");
                l.originalEvent = j;
                i.trigger(l);
                ...
                k.originalEvent = j;
                i.trigger(k, {state: j.hashchangeState || {}})
            }, setup: function () {
                if (f.bound) {
                    return
                }
        ...
        (function (i) {
            i.event.special.throttledresize = {setup: function () {
        ...
        (function (j, o) {
            var m = j(o), l = "orientationchange", f, k, g, p, n = {"0": true, "180": true}, i, e, h;
            ...
            j.event.special.orientationchange = j.extend({}, j.event.special.orientationchange, {setup: function () {
            ...
            j.event.special.orientationchange.orientation = f = function () {
                var s = true, r = a.documentElement;
                if (j.support.orientation) {
                    s = n[o.orientation]
                } else {
        ...
        (function (h, m, e) {
            var f = h(a), i = h.mobile.support.touch, j = "touchmove scroll", n = i ? "touchstart" : "mousedown", l = i ? "touchend" : "mouseup", g = i ? "touchmove" : "mousemove";
            ...
            h.event.special.scrollstart = {enabled: true, setup: function () {
            ...
            h.event.special.tap = {tapholdThreshold: 750, emitTapOnTaphold: true, setup: function () {
                var o = this, q = h(o), p = false;
            ...
            h.event.special.swipe = {scrollSupressionThreshold: 30, durationThreshold: 1000, horizontalDistanceThreshold: 30, verticalDistanceThreshold: 30, getLocation: function (r) {
                var q = m.pageXOffset, p = m.pageYOffset, o = r.clientX, s = r.clientY;
                ...
                var q = p.originalEvent.touches ? p.originalEvent.touches[0] : p, o = h.event.special.swipe.getLocation(q);
                ...
                return false
            }, eventInProgress: false, setup: function () {
            ...
            h.each({scrollstop: "scrollstart", taphold: "tap", swipeleft: "swipe", swiperight: "swipe"}, function (p, o) {
                h.event.special[p] = {setup: function () {
        ...
        (function (h, i) {
            var f = {animation: {}, transition: {}}, g = a.createElement("a"), e = ["", "webkit-", "moz-", "o-"];
            ...
            h(g).remove();
            h.fn.animationComplete = function (p, k, j) {
                var o, n, m = this, l = (!k || k === "animation") ? "animation" : "transition";
                if ((h.support.cssTransitions && l === "transition") || (h.support.cssAnimations && l === "animation")) {
                    ...
                    return h(this).one(f[l].event, function () {
                        clearTimeout(o);
                        p.call(this, arguments)
                    })
                } else {
                    setTimeout(h.proxy(p, this), 0);
                    return h(this)
                }
            };
        ...
        (function (g, i) {
            ...
            g.mobile.path = h = {uiStateKey: "&ui-state", urlParseRE: /^\s*(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/, getLocation: function (j) {
                var k = j ? this.parseUrl(j) : location, l = this.parseUrl(j || location.href).hash;
                l = l === "#" ? "" : l;
                return k.protocol + "//" + k.host + k.pathname + k.search + l
                ...
                return h.parseUrl(k).domain === h.parseUrl(j).domain
                ...
                var o = h.parseUrl(k), r = h.parseUrl(m), s = o.protocol || r.protocol, l = o.protocol ? o.doubleSlash : (o.doubleSlash || r.doubleSlash), p = o.authority || r.authority, q = o.pathname !== "", j = h.makePathAbsolute(o.pathname || r.filename, r.pathname), t = o.search || (!q && r.search) || "", n = o.hash;
                return s + l + p + j + t + n
            }, addSearchParams: function (k, n) {
                var j = h.parseUrl(k), m = (typeof n === "object") ? g.param(n) : n, l = j.search || "?";
                return j.hrefNoSearch + l + (l.charAt(l.length - 1) !== "?" ? "&" : "") + m + (j.hash || "")
            }, convertUrlToDataUrl: function (k) {
                var j = h.parseUrl(k);
                if (h.isEmbeddedPage(j)) {
                    return j.hash.split(f)[0].replace(/^#/, "").replace(/\?.*$/, "")
                } else {
                    if (h.isSameDomain(j, this.documentBase)) {
                        return j.hrefNoHash.replace(this.documentBase.domain, "").split(f)[0]
                    }
                }
                return b.decodeURIComponent(k)
            }, get: function (j) {
                if (j === i) {
                ...
                var j = h.parseUrl(k);
                return j.protocol && j.domain !== this.documentUrl.domain ? true : false
                ...
                var k, q, s, l, o = this.isPath(j), m = this.parseUrl(j), p = m.hash, n = "";
                r = r || (h.isPath(j) ? h.getLocation() : h.getDocumentUrl());
                q = o ? h.stripHash(j) : j;
                q = h.isPath(m.hash) ? h.stripHash(m.hash) : q;
                l = q.indexOf(this.uiStateKey);
                if (l > -1) {
                    n = q.slice(l);
                    q = q.slice(0, l)
                }
                k = h.makeUrlAbsolute(q, r);
                s = this.parseUrl(k).search;
                if (o) {
                    if (h.isPath(p) || p.replace("#", "").indexOf(this.uiStateKey) === 0) {
                        p = ""
                    }
                    if (n && p.indexOf(this.uiStateKey) === -1) {
                        p += n
                    }
                    if (p.indexOf("#") === -1 && p !== "") {
                        p = "#" + p
                    ...
                    k = h.parseUrl(k);
                    k = k.protocol + "//" + k.host + k.pathname + s + p
                } else {
                    k += k.indexOf("#") > -1 ? n : "#" + n
                }
                return k
            ...
            }, getFilePath: function (k) {
                var j = "&" + g.mobile.subPageUrlKey;
                return k && k.split(j)[0].split(f)[0]
            }, isFirstPageUrl: function (l) {
                var k = h.parseUrl(h.makeUrlAbsolute(l, this.documentBase)), n = k.hrefNoHash === this.documentUrl.hrefNoHash || (this.documentBaseDiffers && k.hrefNoHash === this.documentBase.hrefNoHash), j = g.mobile.firstPage, m = j && j[0] ? j[0].id : i;
            ...
            g.extend(g.mobile, {getDocumentUrl: h.getDocumentUrl, getDocumentBase: h.getDocumentBase})
        })(c);
        (function (e, f) {
            ...
            e.extend(e.mobile.History.prototype, {getActive: function () {
                ...
                var i = this.closest(h.url), g = this.activeIndex;
                if (i !== f) {
                    this.activeIndex = i;
        ...
        (function (f, h) {
            var g = f.mobile.path, e = location.href;
            f.mobile.Navigator = function (i) {
                this.history = i;
                this.ignoreInitialHashChange = true;
                f.mobile.window.bind({"popstate.history": f.proxy(this.popstate, this), "hashchange.history": f.proxy(this.hashchange, this)})
            };
            f.extend(f.mobile.Navigator.prototype, {squash: function (j, l) {
                var k, i, m = g.isPath(j) ? g.stripHash(j) : j;
                i = g.squash(j);
                k = f.extend({hash: m, url: i}, l);
                ...
                m = f.extend({url: j, hash: o, title: a.title}, n);
                if (l) {
                    p = new f.Event("popstate");
                    p.originalEvent = {type: "popstate", state: null};
                    this.squash(k, m);
                    if (!i) {
                ...
                this.history.direct({url: (i.originalEvent.state || {}).url || k, present: function (m, l) {
                ...
                this.history.direct({url: j, present: function (m, l) {
                    i.hashchangeState = f.extend({}, m);
                    i.hashchangeState.direction = l
                }, missing: function () {
                    k.add(j, {hash: j, title: a.title})
                }})
            }})
        })(c);
        (function (e, g) {
            ...
            e.mobile.navigate.history.add(f.href, {hash: f.hash})
        })(c);
        (function (g, h) {
            var e = g("head").children("base"), f = {element: (e.length ? e : g("<base>", {href: g.mobile.path.documentBase.hrefNoHash}).prependTo(g("head"))), linkSelector: "[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]", set: function (i) {
                ...
                k.find(f.linkSelector).each(function (m, n) {
                    var o = g(n).is("[href]") ? "href" : g(n).is("[src]") ? "src" : "action", l = g(n).attr(o);
                    l = l.replace(location.protocol + "//" + location.host + location.pathname, "");
                    if (!/^(\w+:|#|\/)/.test(l)) {
                        g(n).attr(o, j + l)
                    }
                })
        ...
        (function (f, i) {
            var e = 0, h = Array.prototype.slice, g = f.cleanData;
            f.cleanData = function (j) {
                for (var k = 0, l; (l = j[k]) != null; k++) {
                    try {
            ...
            f.widget = function (j, k, r) {
                ...
                f.extend(m, p, {version: r.version, _proto: f.extend({}, r), _childConstructors: []});
                q = new k();
                ...
                f.each(r, function (t, s) {
                    ...
                    l[t] = (function () {
                        ...
                        return function () {
                            var y = this._super, w = this._superApply, x;
                            this._super = u;
                            this._superApply = v;
                ...
                m.prototype = f.widget.extend(q, {widgetEventPrefix: p ? (q.widgetEventPrefix || j) : j}, l, {constructor: m, namespace: n, widgetName: j, widgetFullName: o});
                if (p) {
            ...
            f.widget.extend = function (o) {
                var k = h.call(arguments, 1), n = 0, j = k.length, l, m;
                for (; n < j; n++) {
                    for (l in k[n]) {
                        m = k[n][l];
            ...
            f.widget.bridge = function (k, j) {
                ...
                f.fn[k] = function (o) {
                    var m = typeof o === "string", n = h.call(arguments, 1), p = this;
            ...
            f.Widget.prototype = {widgetName: "widget", widgetEventPrefix: "", defaultElement: "<div>", options: {disabled: false, create: null}, _createWidget: function (j, k) {
                ...
                if (k !== this) {
                    ...
                    this._on(true, this.element, {remove: function (l) {
                        if (l.target === k) {
                            this.destroy()
                        }
                    }});
                ...
                f.each(k, function (t, s) {
                    ...
                    var r = t.match(/^(\w+)\s*(.*)$/), p = r[1] + j.eventNamespace, o = r[2];
                    if (o) {
                        n.delegate(o, p, q)
                    } else {
                        l.bind(p, q)
                ...
                this._on(j, {mouseenter: function (k) {
            ...
            f.each({show: "fadeIn", hide: "fadeOut"}, function (k, j) {
        ...
        (function (f, h) {
            var e = /[A-Z]/g, g = function (i) {
                return"-" + i.toLowerCase()
            };
            f.extend(f.Widget.prototype, {_getCreateOptions: function () {
                var j, l, k = this.element[0], i = {};
        ...
        (function (g, h) {
            g.mobile.widgets = {};
            var e = g.widget, f = g.mobile.keepNative;
            g.widget = (function (i) {
                return function () {
                    var k = i.apply(this, arguments), j = k.prototype.widgetName;
            ...
            g.widget("mobile.page", {options: {theme: "a", domCache: false, keepNativeDefault: g.mobile.keepNative, contentTheme: null, enhanced: false}, _createWidget: function () {
                ...
                this.element.find("[" + j + "role='content']").each(function () {
                    var l = g(this), k = this.getAttribute(j + "theme") || h;
                ...
                if (!i.data("mobile-page").options.domCache && i.is(":jqmData(external-page='true')")) {
                    i.bind("pagehide.remove", j || function (n, l) {
                        if (!l.samePage) {
                            var m = g(this), k = new g.Event("pageremove");
                            m.trigger(k);
                ...
                this.element.parent().pagecontainer({theme: i || this.options.theme})
            }, keepNativeSelector: function () {
                var k = this.options, j = g.trim(k.keepNative || ""), l = g.trim(g.mobile.keepNative), n = g.trim(k.keepNativeDefault), m = (f === l ? "" : l), i = (m === "" ? n : "");
        ...
        (function (f, e, g) {
            ...
            f.extend(f.mobile.Transition.prototype, {toPreClass: " ui-page-pre-in", init: function (i, h, k, j) {
                f.extend(this, {name: i, reverse: h, $to: k, $from: j, deferred: new f.Deferred()})
            }, cleanFrom: function () {
                ...
                f.mobile.pageContainer.toggleClass(this.name)
            }, transition: function () {
                var h, i = this.reverse ? " reverse" : "", k = f.mobile.getScreenHeight(), j = f.mobile.maxTransitionWidth !== false && f.mobile.window.width() > f.mobile.maxTransitionWidth;
        ...
        (function (e) {
            ...
            e.extend(e.mobile.SerialTransition.prototype, e.mobile.Transition.prototype, {sequential: true, beforeDoneOut: function () {
                if (this.$from) {
                    this.cleanFrom()
                }
        ...
        (function (e) {
            ...
            e.extend(e.mobile.ConcurrentTransition.prototype, e.mobile.Transition.prototype, {sequential: false, beforeDoneIn: function () {
                if (this.$from) {
                    this.cleanFrom()
                }
            }, beforeStartOut: function (h, g, f) {
        ...
        (function (f) {
            ...
            f.mobile.transitionHandlers = {sequential: f.mobile.SerialTransition, simultaneous: f.mobile.ConcurrentTransition};
        ...
        (function (f, h) {
            f.widget("mobile.pagecontainer", {options: {theme: "a"}, initSelector: false, _create: function () {
                ...
                var k = this._getActiveHistory(), i, l, j;
                if (k) {
                    i = this._getScroll();
                ...
                return f.mobile.navigate.history.getActive()
                ...
                if (f.mobile.hashListeningEnabled) {
                    ...
                    var i = f.mobile.navigate.history.activeIndex, l = i + parseInt(j, 10), k = f.mobile.navigate.history.stack[l].url, m = (j >= 1) ? "forward" : "back";
                    f.mobile.navigate.history.activeIndex = l;
                    f.mobile.navigate.history.previousIndex = i;
                    this.change(k, {direction: m, changeHash: false, fromHashChange: true})
                }
                ...
                if (j) {
                    ...
                    if (j === f.mobile.path.makeUrlAbsolute("#" + i.initialDst, this._getDocumentBase()) && i.stack.length && i.stack[0].url !== i.initialDst.replace(f.mobile.dialogHashKey, "")) {
                        j = this._getInitialContent()
                    }
                }
                return j || this._getInitialContent()
            }, _handleDialog: function (i, j) {
                var m, l, k = this.getActivePage();
                if (k && !k.hasClass("ui-dialog")) {
                    if (j.direction === "back") {
                        this.back()
                    } else {
                        this.forward()
                    ...
                    f.extend(i, {role: l.role, transition: l.transition, reverse: j.direction === "back"})
                }
                return m
            }, _handleNavigate: function (i, k) {
                var n = f.mobile.path.stripHash(i), l = this._getHistory(), m = l.stack.length === 0 ? "none" : h, j = {changeHash: false, fromHashChange: true, reverse: k.direction === "back"};
                f.extend(j, k, {transition: (l.getLast() || {}).transition || m});
                if (l.activeIndex > 0 && n.indexOf(f.mobile.dialogHashKey) > -1 && l.initialDst !== n) {
                ...
                return i.page({role: j})
            }, _include: function (j, i) {
                j.appendTo(this.element);
                this._enhance(j, i.role);
                j.page("bindRemove")
            }, _find: function (j) {
                var i = this._createFileUrl(j), m = this._createDataUrl(j), l, k = this._getInitialContent();
                l = this.element.children("[data-" + this._getNs() + "url='" + m + "']");
                ...
                l.attr("data-" + this._getNs() + "url", f.mobile.path.convertUrlToDataUrl(i)).attr("data-" + this._getNs() + "external-page", true);
                return l
                ...
                var i = f.Event("page" + j), k = f.Event(this.widgetName + j);
                (l || this.element).trigger(i, m);
                this.element.trigger(k, m);
                return{deprecatedEvent: i, event: k}
            }, _loadSuccess: function (k, m, l, j) {
                var i = this._createFileUrl(k), n = this._createDataUrl(k);
                return f.proxy(function (p, t, s) {
                    var q, r = new RegExp("(<[^>]+\\bdata-" + this._getNs() + "role=[\"']?page[\"']?[^>]*>)"), o = new RegExp("\\bdata-" + this._getNs() + "url=[\"']?([^\"'>]*)[\"']?");
                    if (r.test(p) && RegExp.$1 && o.test(RegExp.$1) && RegExp.$1) {
                    ...
                    q = this._parse(p, i);
                    this._setLoadedTitle(q, p);
                    m.xhr = s;
                    m.textStatus = t;
                    m.page = q;
                    m.content = q;
                    if (!this._trigger("load", h, m)) {
                        return
                    }
                    if (this._isRewritableBaseTag() && q) {
                        this._getBase().rewrite(i, q)
                    }
                    this._include(q, l);
                    if (k.indexOf("&" + f.mobile.subPageUrlKey) > -1) {
                        q = this.element.children("[data-" + this._getNs() + "url='" + n + "']")
                    }
                    if (l.showLoadMsg) {
                        this._hideLoading()
                    }
            ...
            }, _loadDefaults: {type: "get", data: h, reloadPage: false, reload: false, role: h, showLoadMsg: false, loadMsgDelay: 50}, load: function (j, r) {
                var q = (r && r.deferred) || f.Deferred(), k = f.extend({}, this._loadDefaults, r), m = null, l = f.mobile.path.makeUrlAbsolute(j, this._findBaseWithDefault()), o, n, p, i;
                k.reload = k.reloadPage;
                ...
                o = this._createFileUrl(l);
                n = this._createDataUrl(l);
                m = this._find(l);
                if (m.length === 0 && f.mobile.path.isEmbeddedPage(o) && !f.mobile.path.isFirstPageUrl(o)) {
                    q.reject(l, k);
                    return
                }
                this._getBase().reset();
                ...
                i = {url: j, absUrl: l, dataUrl: n, deferred: q, options: k};
                p = this._triggerWithDeprecated("beforeload", i);
                if (p.deprecatedEvent.isDefaultPrevented() || p.event.isDefaultPrevented()) {
                    return
                }
                if (k.showLoadMsg) {
                ...
                f.ajax({url: o, type: k.type, data: k.data, contentType: k.contentType, dataType: "html", success: this._loadSuccess(l, i, k, q), error: this._loadError(l, i, k, q)})
                ...
                if (k) {
                    ...
                    this._triggerWithDeprecated(j + "hide", {nextPage: l, samePage: i}, k)
                }
                this._triggerWithDeprecated(j + "show", {prevPage: k || f("")}, l)
            }, _cssTransition: function (p, o, l) {
                var n = l.transition, k = l.reverse, j = l.deferred, i, m;
            ...
            }, _triggerPageBeforeChange: function (l, j, i) {
                var k = new f.Event("pagebeforechange");
                f.extend(j, {toPage: l, options: i});
                if (f.type(l) === "string") {
                    j.absUrl = f.mobile.path.makeUrlAbsolute(l, this._findBaseWithDefault())
                } else {
                    j.absUrl = i.absUrl
                }
                ...
                var k = f.extend({}, f.mobile.changePage.defaults, i), j = {};
                ...
                if (y && y[0] === k[0] && !u.allowSamePageTransition) {
                    ...
                    this.element.trigger("pagechange", i);
                    if (u.fromHashChange) {
                        f.mobile.navigate.history.direct({url: l})
                    }
                    return
                }
                k.page({role: u.role});
                ...
                if (n && o) {
                    ...
                    if (f.mobile.navigate.history.activeIndex === 0 && l === f.mobile.navigate.history.initialDst) {
                        l += f.mobile.dialogHashKey
                    }
                }
                ...
                if (l && !u.fromHashChange) {
                    ...
                    x = {transition: u.transition, title: m, pageUrl: s, role: u.role};
                    if (u.changeHash !== false && f.mobile.hashListeningEnabled) {
                        f.mobile.navigate(l, x, true)
                    } else {
                ...
                p = f.Deferred();
                this._cssTransition(k, y, {transition: u.transition, reverse: u.reverse, deferred: p});
        ...
        (function (i, k) {
            var j = i.Deferred(), e = i.Deferred(), h = i.mobile.path.documentUrl, f = null;

            function g(l) {
                while (l) {
                    if ((typeof l.nodeName === "string") && l.nodeName.toLowerCase() === "a") {
                        break
                    }
                    l = l.parentNode
                }
            ...
            i.mobile.loadPage = function (m, n) {
                var l;
                n = n || {};
                l = (n.pageContainer || i.mobile.pageContainer);
                n.deferred = i.Deferred();
                l.pagecontainer("load", m, n);
                return n.deferred.promise()
            };
            i.mobile.back = function () {
                var l = b.navigator;
                if (this.phonegapNavigationEnabled && l && l.app && l.app.backHistory) {
                    l.app.backHistory()
                } else {
                    i.mobile.pageContainer.pagecontainer("back")
                }
            };
            i.mobile.focusPage = function (m) {
                var n = m.find("[autofocus]"), l = m.find(".ui-title:eq(0)");
                if (n.length) {
                    n.focus();
                    return
                }
            ...
            i.mobile._maybeDegradeTransition = i.mobile._maybeDegradeTransition || function (l) {
                return l
            };
            i.mobile.changePage = function (m, l) {
                i.mobile.pageContainer.pagecontainer("change", m, l)
            };
            i.mobile.changePage.defaults = {transition: k, reverse: false, changeHash: false, fromHashChange: false, role: k, duplicateCachedPage: k, pageContainer: k, showLoadMsg: false, dataUrl: k, fromPage: k, allowSamePageTransition: false};
            i.mobile._registerInternalEvents = function () {
                var l = function (n, q) {
                    var p, o = true, r, m, s;
                    if (!i.mobile.ajaxEnabled || n.is(":jqmData(ajax='false')") || !n.jqmHijackable().length || n.attr("target")) {
                        return false
                    }
                    p = (f && f.attr("formaction")) || n.attr("action");
                    s = (n.attr("method") || "get").toLowerCase();
                    if (!p) {
                        p = i.mobile.getClosestBaseUrl(n);
                        if (s === "get") {
                            p = i.mobile.path.parseUrl(p).hrefNoSearch
                        }
                        if (p === i.mobile.path.documentBase.hrefNoHash) {
                            p = h.hrefNoSearch
                        }
                    }
                    p = i.mobile.path.makeUrlAbsolute(p, i.mobile.getClosestBaseUrl(n));
                    if ((i.mobile.path.isExternal(p) && !i.mobile.path.isPermittedCrossDomainRequest(h, p))) {
                        return false
                    }
                    if (!q) {
                        r = n.serializeArray();
                        if (f && f[0].form === n[0]) {
                            ...
                            if (m) {
                                ...
                                if (m) {
                                    r.push({name: m, value: f.attr("value")})
                                }
                            }
                        }
                        o = {url: p, options: {type: s, data: i.param(r), transition: n.jqmData("transition"), reverse: n.jqmData("direction") === "reverse", reloadPage: true}}
                    }
                    return o
                };
                i.mobile.document.delegate("form", "submit", function (m) {
                    var n;
                    if (!m.isDefaultPrevented()) {
                        n = l(i(this));
                        if (n) {
                            i.mobile.changePage(n.url, n.options)
                        }
                    }
                });
                i.mobile.document.bind("vclick", function (p) {
                    var o, n, q = p.target, m = false;
                    if (p.which > 1 || !i.mobile.linkBindingEnabled) {
                        return
                    }
                    f = i(q);
                    if (i.data(q, "mobile-button")) {
                        if (!l(i(q).closest("form"), true)) {
                            return
                        }
                        if (q.parentNode) {
                            q = q.parentNode
                        ...
                        q = g(q);
                        if (!(q && i.mobile.path.parseUrl(q.getAttribute("href") || "#").hash !== "#")) {
                            return
                        }
                        if (!i(q).jqmHijackable().length) {
                            return
                        }
                    }
                    if (!!~q.className.indexOf("ui-link-inherit")) {
                        if (q.parentNode) {
                            n = i.data(q.parentNode, "buttonElements")
                        }
                    } else {
                        n = i.data(q, "buttonElements")
                    }
                    if (n) {
                        q = n.outer
                    } else {
                    ...
                    if (o.length > 0 && !(o.hasClass("ui-state-disabled" || o.hasClass("ui-disabled")))) {
                        i.mobile.removeActiveLinkClass(true);
                        i.mobile.activeClickedLink = o;
                        i.mobile.activeClickedLink.addClass(i.mobile.activeBtnClass)
                    }
                });
                i.mobile.document.bind("click", function (m) {
                    if (!i.mobile.linkBindingEnabled || m.isDefaultPrevented()) {
                        return
                    }
                    var w = g(m.target), u = i(w), q = function () {
                        b.setTimeout(function () {
                            i.mobile.removeActiveLinkClass(true)
                        }, 200)
                    }, t, o, p, n, v, s, r;
                    if (i.mobile.activeClickedLink && i.mobile.activeClickedLink[0] === m.target.parentNode) {
                        q()
                    }
                    if (!w || m.which > 1 || !u.jqmHijackable().length) {
                        return
                    }
                    if (u.is(":jqmData(rel='back')")) {
                        i.mobile.back();
                        return false
                    }
                    t = i.mobile.getClosestBaseUrl(u);
                    o = i.mobile.path.makeUrlAbsolute(u.attr("href") || "#", t);
                    if (!i.mobile.ajaxEnabled && !i.mobile.path.isEmbeddedPage(o)) {
                        q();
                        return
                    }
                    if (o.search("#") !== -1) {
                        ...
                        if (!o) {
                            ...
                            if (i.mobile.path.isPath(o)) {
                                o = i.mobile.path.makeUrlAbsolute(o, t)
                            } else {
                                o = i.mobile.path.makeUrlAbsolute("#" + o, h.hrefNoHash)
                            }
                        }
                    }
                    p = u.is("[rel='external']") || u.is(":jqmData(ajax='false')") || u.is("[target]");
                    n = p || (i.mobile.path.isExternal(o) && !i.mobile.path.isPermittedCrossDomainRequest(h, o));
                    if (n) {
                        q();
                        return
                    }
                    v = u.jqmData("transition");
                    s = u.jqmData("direction") === "reverse" || u.jqmData("back");
                    r = u.attr("data-" + i.mobile.ns + "rel") || k;
                    i.mobile.changePage(o, {transition: v, reverse: s, role: r, link: u})
                });
                i.mobile.pageContainer.pagecontainer();
                i.mobile.document.bind("pageshow", function () {
                    if (e) {
                        e.done(i.mobile.resetActivePageHeight)
                    } else {
            ...
            i.mobile.window.load(function () {
                e.resolve();
                e = null
            });
            i.when(j, i.mobile.navreadyDeferred).done(function () {
                i.mobile._registerInternalEvents()
            })
        })(c);
        (function (g) {
            var f = "ui-loader", e = g("html");
            g.widget("mobile.loader", {options: {theme: "a", textVisible: false, html: "", text: "loading"}, defaultHtml: "", fakeFixLoader: function () {
                var h = g("." + g.mobile.activeBtnClass).first();
                this.element.css({top: g.support.scrollTop && this.window.scrollTop() + this.window.height() / 2 || h.length && h.offset().top || 100})
            }, checkLoaderPosition: function () {
                var i = this.element.offset(), h = this.window.scrollTop(), j = g.mobile.getScreenHeight();
                ...
                this.element.appendTo(g.mobile.pageContainer);
                ...
                g.mobile.window.unbind("scroll", this.fakeFixLoader);
                g.mobile.window.unbind("scroll", this.checkLoaderPosition)
            }})
        })(c, this);
        (function (g, f, j) {
            var e = g("html"), i = g.mobile.window;
            ...
            e.addClass("");
            setTimeout(h, 5000);
            g.extend(g.mobile, {initializePage: function () {
                var n = g.mobile.path, m = g(":jqmData(role='page'), :jqmData(role='dialog')"), l = n.stripHash(n.stripQueryParams(n.parseLocation().hash)), k = a.getElementById(l);
                if (!m.length) {
                    m = g("body").wrapInner("<div data-" + g.mobile.ns + "role='page'></div>").children(0)
                }
                m.each(function () {
                    var o = g(this);
                    if (!o[0].getAttribute("data-" + g.mobile.ns + "url")) {
                        o.attr("data-" + g.mobile.ns + "url", o.attr("id") || location.pathname + location.search)
                    }
                });
                g.mobile.firstPage = m.first();
                g.mobile.pageContainer = g.mobile.firstPage.parent().addClass("").pagecontainer();
                ...
                if (!(g.mobile.hashListeningEnabled && g.mobile.path.isHashValid(location.hash) && (g(k).is(":jqmData(role='page')") || g.mobile.path.isPath(l) || l === g.mobile.dialogHashKey))) {
                    if (g.mobile.path.isHashValid(location.hash)) {
                        g.mobile.navigate.history.initialDst = l.replace("#", "")
                    }
                    if (g.event.special.navigate.isPushStateEnabled()) {
                        g.mobile.navigate.navigator.squash(n.parseLocation().href)
                    }
                    g.mobile.changePage(g.mobile.firstPage, {transition: "none", reverse: false, changeHash: false, fromHashChange: false})
                } else {
                    if (!g.event.special.navigate.isPushStateEnabled()) {
        ...
        (function (e, f) {
            e.mobile.behaviors.addFirstLastClasses = {_getVisibles: function (h, g) {
                var i;
                if (g) {
                    i = h.not(".ui-screen-hidden")
                } else {
                    i = h.filter(":visible");
                    if (i.length === 0) {
                        i = h.not(".ui-screen-hidden")
                ...
                return i
            }, _addFirstLastClasses: function (i, h, g) {
                i.removeClass("ui-first-child ui-last-child");
                h.eq(0).addClass("ui-first-child").end().last().addClass("ui-last-child");
                if (!g) {
                    this.element.trigger("updatelayout")
                }
            }, _removeFirstLastClasses: function (g) {
                g.removeClass("ui-first-child ui-last-child")
            }}
        })(c);
        (function (e, f) {
            e.widget("mobile.controlgroup", e.extend({options: {enhanced: false, theme: null, shadow: false, corners: true, excludeInvisible: true, type: "vertical", mini: false}, _create: function () {
                var h = this.element, g = this.options;
                if (e.fn.buttonMarkup) {
                    this.element.find(e.fn.buttonMarkup.initSelector).buttonMarkup()
                }
                e.each(this._childWidgets, e.proxy(function (j, i) {
                    if (e.mobile[i]) {
                        this.element.find(e.mobile[i].initSelector).not(e.mobile.page.prototype.keepNativeSelector())[i]()
                    }
                }, this));
                e.extend(this, {_ui: null, _initialRefresh: true});
                if (g.enhanced) {
                    this._ui = {groupLegend: h.children(".ui-controlgroup-label").children(), childWrapper: h.children(".ui-controlgroup-controls")}
                } else {
                    this._ui = this._enhance()
                }
            }, _childWidgets: ["checkboxradio", "selectmenu", "button"], _themeClassFromOption: function (g) {
                return(g ? (g === "none" ? "" : "ui-group-theme-" + g) : "")
            }, _enhance: function () {
                var h = this.element, g = this.options, i = {groupLegend: h.children("legend"), childWrapper: h.addClass("ui-controlgroup ui-controlgroup-" + (g.type === "horizontal" ? "horizontal" : "vertical") + " " + this._themeClassFromOption(g.theme) + " " + (g.corners ? "ui-corner-all " : "") + (g.mini ? "ui-mini " : "")).wrapInner("<div class='ui-controlgroup-controls " + (g.shadow === true ? "ui-shadow" : "") + "'></div>").children()};
                ...
                var i = this.container(), h = i.find(".ui-btn").not(".ui-slider-handle"), g = this._initialRefresh;
        ...
        (function (e, f) {
            e.widget("mobile.button", {initSelector: "input[type='button'], input[type='submit'], input[type='reset']", options: {theme: null, icon: null, iconpos: "left", iconshadow: false, corners: true, shadow: true, inline: null, mini: null, wrapperClass: null, enhanced: false}, _create: function () {
                ...
                e.extend(this, {wrapper: this.element.parent()});
                this._on({focus: function () {
                ...
                var g = this.options, h = this._getIconClasses(this.options);
        ...
        (function (e, f) {
            ...
            e.widget("mobile.checkboxradio", e.extend({initSelector: "input:not( :jqmData(role='flipswitch' ) )[type='checkbox']:not('.switch'),input[type='radio']:not( :jqmData(role='flipswitch' ))", options: {theme: "inherit", mini: false, wrapperClass: null, enhanced: false, iconpos: "left"}, _create: function () {
                var i = this.element, p = this.options, h = function (o, q) {
                    return o.jqmData(q) || o.closest("form, fieldset").jqmData(q)
                }, k = i.closest("label"), j = k.length ? k : i.closest("form, fieldset, :jqmData(role='page'), :jqmData(role='dialog')").find("label").filter("[for='" + g(i[0].id) + "']").first(), n = i[0].type, l = "ui-" + n + "-on", m = "ui-" + n + "-off";
                ...
                p.iconpos = h(i, "iconpos") || j.attr("data-" + e.mobile.ns + "iconpos") || p.iconpos, p.mini = h(i, "mini") || p.mini;
                e.extend(this, {input: i, label: j, parentLabel: k, inputtype: n, checkedClass: l, uncheckedClass: m});
                if (!this.options.enhanced) {
                    this._enhance()
                }
                this._on(j, {vmouseover: "_handleLabelVMouseOver", vclick: "_handleLabelVClick"});
                this._on(i, {vmousedown: "_cacheVals", vclick: "_handleInputVClick", focus: "_handleInputFocus", blur: "_handleInputBlur"});
                ...
                var h, m, j = this.element[0], i = j.name, k = j.form, l = this.element.parents().last().get(0), n = this.element;
                ...
                this._getInputSet().each(function () {
                    var i = e(this);
                    if (this.checked || h.inputtype === "checkbox") {
                        i.trigger("change")
                    }
                ...
                var i = this._hasIcon(), m = this.element[0].checked, l = e.mobile.activeBtnClass, j = "ui-btn-icon-" + this.options.iconpos, k = [], h = [];
                if (i) {
                    h.push(l);
                    k.push(j)
                } else {
                ...
                if (m) {
                    k.push(this.checkedClass);
                    h.push(this.uncheckedClass)
                } else {
                    k.push(this.uncheckedClass);
                    h.push(this.checkedClass)
                }
                this.label.addClass(k.join(" ")).removeClass(h.join(" "))
            }, widget: function () {
                return this.label.parent()
            }, _setOptions: function (k) {
                var j = this.label, i = this.options, l = this.widget(), h = this._hasIcon();
                if (k.disabled !== f) {
        ...
        (function (f, g) {
            ...
            f.widget("mobile.listview", f.extend({options: {theme: null, countTheme: null, dividerTheme: null, icon: "carat-r", splitIcon: "carat-r", splitTheme: null, corners: true, shadow: true, inset: false}, _create: function () {
                var i = this, h = "";
                ...
                return f(h)
            }, _beforeListviewRefresh: f.noop, _afterListviewRefresh: f.noop, refresh: function (w) {
                var A, r, j, I, i, u, E, H, J, C, p, G, F, t, q, n, z, K, m, y, D = this.options, h = this.element, x = !!f.nodeName(h[0], "ol"), l = h.attr("start"), v = {}, s = h.find(".ui-li-count"), B = e(h[0], "counttheme") || this.options.countTheme, k = B ? "ui-body-" + B : "ui-body-inherit";
                if (D.theme) {
...
!function (v) {
    function A(a, e, c) {
        if (c) {
            if ("object" != typeof a && (a = {}), "boolean" != typeof a.isMenu) {
                var d = c.children();
                a.isMenu = 1 == d.length && d.is(e.panelNodetype)
            }
            return a
        }
        return a = v.extend(!0, {}, v[y].defaults, a), ("top" == a.position || "bottom" == a.position) && ("back" == a.zposition || "next" == a.zposition) && (v[y].deprecated('Using position "' + a.position + '" in combination with zposition "' + a.zposition + '"', 'zposition "front"'), a.zposition = "front"), a
    }

    function j(a) {
        return a = v.extend(!0, {}, v[y].configuration, a), "string" != typeof a.pageSelector && (a.pageSelector = "> " + a.pageNodetype), a
    }

    function B() {
        b.$wndw = v(window), b.$html = v("html"), b.$body = v("body"), b.$allMenus = v(), v.each([w, x, z], function (d, c) {
            c.add = function (h) {
                h = h.split(" ");
                for (var i in h) {
                    c[h[i]] = c.mm(h[i])
            ...
            return"mm-" + c
        }, w.add("menu ismenu panel list subtitle selected label spacer current highest hidden page blocker modal background opened opening subopened subopen fullsubopen subclose"), w.umm = function (c) {
            return"mm-" == c.slice(0, 3) && (c = c.slice(3)), c
        }, x.mm = function (c) {
            return"mm-" + c
        }, x.add("parent style"), z.mm = function (c) {
            return c + ".mm"
        }, z.add("toggle open opening opened close closing closed update setPage setSelected transitionend webkitTransitionEnd mousedown touchstart mouseup touchend scroll touchmove click keydown keyup resize"), b.$wndw.on(z.keydown, function (c) {
            return b.$html.hasClass(w.opened) && 9 == c.keyCode ? (c.preventDefault(), !1) : void 0
        });
        var a = 0;
        b.$wndw.on(z.resize, function (d, h) {
            if (h || b.$html.hasClass(w.opened)) {
                var c = b.$wndw.height();
                (h || c != a) && (a = c, b.$page.css("minHeight", c))
            }
        }), v[y]._c = w, v[y]._d = x, v[y]._e = z, v[y].glbl = b
    }

    function g(a, e) {
        if (a.hasClass(w.current)) {
            return !1
        }
        var c = v("." + w.panel, e), d = c.filter("." + w.current);
        return c.removeClass(w.highest).removeClass(w.current).not(a).not(d).addClass(w.hidden), a.hasClass(w.opened) ? d.addClass(w.highest).removeClass(w.opened).removeClass(w.subopened) : (a.addClass(w.highest), d.addClass(w.subopened)), a.removeClass(w.hidden).removeClass(w.subopened).addClass(w.current).addClass(w.opened), "open"
    }
    ...
    function m(d, a, i) {
        ...
        d.one(z.transitionend, h), d.one(z.webkitTransitionEnd, h), setTimeout(h, 1.1 * i)
    }

    var y = "mmenu", k = "4.2.2";
    if (!v[y]) {
        var b = {$wndw: null, $html: null, $body: null, $page: null, $blck: null, $allMenus: null}, w = {}, x = {}, z = {}, f = 0, q = 0;
        v[y] = function (c, a, d) {
            return b.$allMenus = b.$allMenus.add(c), this.$menu = c, this.opts = a, this.conf = d, this.serialnr = f++, this._init(), this
        }, v[y].prototype = {open: function () {
            var a = this;
            return this._openSetup(), setTimeout(function () {
                a._openFinish()
            }, 50), "open"
        }, _openSetup: function () {
            q = b.$wndw.scrollTop(), this.$menu.addClass(w.current), b.$allMenus.not(this.$menu).trigger(z.close), b.$page.data(x.style, b.$page.attr("style") || ""), b.$wndw.trigger(z.resize, [!0]), this.opts.modal && b.$html.addClass(w.modal), this.opts.moveBackground && b.$html.addClass(w.background), "left" != this.opts.position && b.$html.addClass(w.mm(this.opts.position)), "back" != this.opts.zposition && b.$html.addClass(w.mm(this.opts.zposition)), this.opts.classes && b.$html.addClass(this.opts.classes), b.$html.addClass(w.opened), this.$menu.addClass(w.opened)
        }, _openFinish: function () {
            var a = this;
            m(b.$page, function () {
                a.$menu.trigger(z.opened)
            }, this.conf.transitionDuration), b.$html.addClass(w.opening), this.$menu.trigger(z.opening)
        }, close: function () {
            var a = this;
            return m(b.$page, function () {
                a.$menu.removeClass(w.current).removeClass(w.opened), b.$html.removeClass(w.opened).removeClass(w.modal).removeClass(w.background).removeClass(w.mm(a.opts.position)).removeClass(w.mm(a.opts.zposition)), a.opts.classes && b.$html.removeClass(a.opts.classes), b.$page.attr("style", b.$page.data(x.style)), a.$menu.trigger(z.closed)
            }, this.conf.transitionDuration), b.$html.removeClass(w.opening), this.$menu.trigger(z.closing), "close"
        }, _init: function () {
            if (this.opts = A(this.opts, this.conf, this.$menu), this.direction = this.opts.slidingSubmenus ? "horizontal" : "vertical", this._initPage(b.$page), this._initMenu(), this._initBlocker(), this._initPanles(), this._initLinks(), this._initOpenClose(), this._bindCustomEvents(), v[y].addons) {
                for (var a = 0; a < v[y].addons.length; a++) {
                    "function" == typeof this["_addon_" + v[y].addons[a]] && this["_addon_" + v[y].addons[a]]()
                }
            }
        }, _bindCustomEvents: function () {
            var a = this;
            this.$menu.off(z.open + " " + z.close + " " + z.setPage + " " + z.update).on(z.open + " " + z.close + " " + z.setPage + " " + z.update, function (d) {
                d.stopPropagation()
            }), this.$menu.on(z.open, function (d) {
                return v(this).hasClass(w.current) ? (d.stopImmediatePropagation(), !1) : a.open()
            }).on(z.close, function (d) {
                return v(this).hasClass(w.current) ? a.close() : (d.stopImmediatePropagation(), !1)
            }).on(z.setPage, function (d, h) {
                a._initPage(h), a._initOpenClose()
            });
            var c = this.$menu.find(this.opts.isMenu && "horizontal" != this.direction ? "ul, ol" : "." + w.panel);
            c.off(z.toggle + " " + z.open + " " + z.close).on(z.toggle + " " + z.open + " " + z.close, function (d) {
                d.stopPropagation()
            }), "horizontal" == this.direction ? c.on(z.open, function () {
                return g(v(this), a.$menu)
            }) : c.on(z.toggle, function () {
                var d = v(this);
                return d.triggerHandler(d.parent().hasClass(w.opened) ? z.close : z.open)
            }).on(z.open, function () {
                return v(this).parent().addClass(w.opened), "open"
            }).on(z.close, function () {
                return v(this).parent().removeClass(w.opened), "close"
            })
        }, _initBlocker: function () {
            var a = this;
            b.$blck || (b.$blck = v('<div id="' + w.blocker + '" />').appendTo(b.$body)), b.$blck.off(z.touchstart).on(z.touchstart, function (c) {
                c.preventDefault(), c.stopPropagation(), b.$blck.trigger(z.mousedown)
            }).on(z.mousedown, function (c) {
                c.preventDefault(), b.$html.hasClass(w.modal) || a.$menu.trigger(z.close)
            })
        }, _initPage: function (a) {
            a || (a = v(this.conf.pageSelector, b.$body), a.length > 1 && (v[y].debug("Multiple nodes found for the page-node, all nodes are wrapped in one <" + this.conf.pageNodetype + ">."), a = a.wrapAll("<" + this.conf.pageNodetype + " />").parent())), a.addClass(w.page), b.$page = a
        }, _initMenu: function () {
            this.conf.clone && (this.$menu = this.$menu.clone(!0), this.$menu.add(this.$menu.find("*")).filter("[id]").each(function () {
                v(this).attr("id", w.mm(v(this).attr("id")))
            })), this.$menu.contents().each(function () {
                3 == v(this)[0].nodeType && v(this).remove()
            }), this.$menu.prependTo("body").addClass(w.menu), this.$menu.addClass(w.mm(this.direction)), this.opts.classes && this.$menu.addClass(this.opts.classes), this.opts.isMenu && this.$menu.addClass(w.ismenu), "left" != this.opts.position && this.$menu.addClass(w.mm(this.opts.position)), "back" != this.opts.zposition && this.$menu.addClass(w.mm(this.opts.zposition))
        }, _initPanles: function () {
            var e = this;
            this.__refactorClass(v("." + this.conf.listClass, this.$menu), "list"), this.opts.isMenu && v("ul, ol", this.$menu).not(".mm-nolist").addClass(w.list);
            var p = v("." + w.list + " > li", this.$menu);
            this.__refactorClass(p.filter("." + this.conf.selectedClass), "selected"), this.__refactorClass(p.filter("." + this.conf.labelClass), "label"), this.__refactorClass(p.filter("." + this.conf.spacerClass), "spacer"), p.off(z.setSelected).on(z.setSelected, function (a, i) {
                a.stopPropagation(), p.removeClass(w.selected), "boolean" != typeof i && (i = !0), i && v(this).addClass(w.selected)
            }), this.__refactorClass(v("." + this.conf.panelClass, this.$menu), "panel"), this.$menu.children().filter(this.conf.panelNodetype).add(this.$menu.find("." + w.list).children().children().filter(this.conf.panelNodetype)).addClass(w.panel);
            var h = v("." + w.panel, this.$menu);
            h.each(function (r) {
                var a = v(this), i = a.attr("id") || w.mm("m" + e.serialnr + "-p" + r);
                a.attr("id", i)
            }), h.find("." + w.panel).each(function () {
                var E = v(this), C = E.is("ul, ol") ? E : E.find("ul ,ol").first(), D = E.parent(), u = D.find("> a, > span .chat-name"), t = D.closest("." + w.panel);
                if (E.data(x.parent, D), D.parent().is("." + w.list)) {
                    var r = v('<a class="' + w.subopen + '" href="#' + E.attr("id") + '" />').insertBefore(u);
                    u.is("a") || r.addClass(w.fullsubopen), "horizontal" == e.direction && C.prepend('<li class="' + w.subtitle + '"><a class="' + w.subclose + '" href="#' + t.attr("id") + '">' + u.text() + "</a></li>")
                }
            });
            var l = "horizontal" == this.direction ? z.open : z.toggle;
            if (h.each(function () {
                var i = v(this), a = i.attr("id");
                v('a[href="#' + a + '"]', e.$menu).off(z.click).on(z.click, function (n) {
                    n.preventDefault(), i.trigger(l)
                })
            }), "horizontal" == this.direction) {
                var d = v("." + w.list + " > li." + w.selected, this.$menu);
                d.add(d.parents("li")).parents("li").removeClass(w.selected).end().each(function () {
                    var a = v(this), i = a.find("> ." + w.panel);
                    i.length && (a.parents("." + w.panel).addClass(w.subopened), i.addClass(w.opened))
                }).closest("." + w.panel).addClass(w.opened).parents("." + w.panel).addClass(w.subopened)
            } else {
                v("li." + w.selected, this.$menu).addClass(w.opened).parents("." + w.selected).removeClass(w.selected)
            }
            var c = h.filter("." + w.opened);
            c.length || (c = h.first()), c.addClass(w.opened).last().addClass(w.current), "horizontal" == this.direction && h.find("." + w.panel).appendTo(this.$menu)
        }, _initLinks: function () {
            var a = this;
            v("." + w.list + " > li > a", this.$menu).not("." + w.subopen).not("." + w.subclose).not('[rel="external"]').not('[target="_blank"]').off(z.click).on(z.click, function (h) {
                var d = v(this), e = d.attr("href");
                a.__valueOrFn(a.opts.onClick.setSelected, d) && d.parent().trigger(z.setSelected);
                var c = a.__valueOrFn(a.opts.onClick.preventDefault, d, "#" == e.slice(0, 1));
                c && h.preventDefault(), a.__valueOrFn(a.opts.onClick.blockUI, d, !c) && b.$html.addClass(w.blocking), a.__valueOrFn(a.opts.onClick.close, d, c) && a.$menu.triggerHandler(z.close)
            })
        }, _initOpenClose: function () {
            var a = this, c = this.$menu.attr("id");
            c && c.length && (this.conf.clone && (c = w.umm(c)), v('a[href="#' + c + '"]').off(z.click).on(z.click, function (d) {
                d.preventDefault(), a.$menu.trigger(z.open)
            }));
            var c = b.$page.attr("id");
            c && c.length && v('a[href="#' + c + '"]').off(z.click).on(z.click, function (d) {
                d.preventDefault(), a.$menu.trigger(z.close)
            })
        }, __valueOrFn: function (c, a, d) {
            return"function" == typeof c ? c.call(a[0]) : "undefined" == typeof c && "undefined" != typeof d ? d : c
        }, __refactorClass: function (c, a) {
            c.removeClass(this.conf[a + "Class"]).addClass(w[a])
        }}, v.fn[y] = function (c, a) {
            return b.$wndw || B(), c = A(c, a), a = j(a), this.each(function () {
                var d = v(this);
                d.data(y) || d.data(y, new v[y](d, c, a))
            })
        }, v[y].version = k, v[y].defaults = {position: "left", zposition: "back", moveBackground: !0, slidingSubmenus: !0, modal: !1, classes: "", onClick: {setSelected: !0}}, v[y].configuration = {preventTabbing: !0, panelClass: "Panel", listClass: "List", selectedClass: "Selected", labelClass: "Label", spacerClass: "Spacer", pageNodetype: "div", panelNodetype: "ul, ol, div", transitionDuration: 400}, function () {
            var c = window.document, h = window.navigator.userAgent, d = (document.createElement("div").style, "ontouchstart" in c), e = "WebkitOverflowScrolling" in c.documentElement.style, a = function () {
                return h.indexOf("Android") >= 0 ? 2.4 > parseFloat(h.slice(h.indexOf("Android") + 8)) : !1
            }();
            v[y].support = {touch: d, oldAndroidBrowser: a, overflowscrolling: function () {
                return d ? e ? !0 : a ? !1 : !0 : !0
            }()}
        }(), v[y].debug = function () {
        }, v[y].deprecated = function (c, a) {
            "undefined" != typeof console && "undefined" != typeof console.warn && console.warn("MMENU: " + c + " is deprecated, use " + a + " instead.")
        }
    }
}(jQuery);
!function (a) {
    ...
    a[b].prototype["_addon_" + c] = function () {
        var j = this, f = this.opts[c], e = a[b]._c, h = a[b]._d, i = a[b]._e;
        e.add("counter noresults"), i.add("updatecounters"), "boolean" == typeof f && (f = {add: f, update: f}), "object" != typeof f && (f = {}), f = a.extend(!0, {}, a[b].defaults[c], f), f.count && (a[b].deprecated('the option "count" for counters, the option "update"'), f.update = f.count), this.__refactorClass(a("em." + this.conf.counterClass, this.$menu), "counter");
        var g = a("." + e.panel, this.$menu);
        if (f.add && g.each(function () {
            var l = a(this), p = l.data(h.parent);
            if (p) {
                var m = a('<em class="' + e.counter + '" />'), d = p.find("> a." + e.subopen);
                d.parent().find("em." + e.counter).length || d.before(m)
            }
        }), f.update) {
            var k = a("em." + e.counter, this.$menu);
            k.off(i.updatecounters).on(i.updatecounters, function (d) {
                d.stopPropagation()
            }).each(function () {
                var d = a(this), l = a(d.next().attr("href"), j.$menu);
                l.is("." + e.list) || (l = l.find("> ." + e.list)), l.length && d.on(i.updatecounters, function () {
                    var m = l.children().not("." + e.label).not("." + e.subtitle).not("." + e.hidden).not("." + e.noresults);
                    d.html(m.length)
                })
            }).trigger(i.updatecounters), this.$menu.on(i.update, function () {
                k.trigger(i.updatecounters)
            })
        }
...
!function (d) {
    function c(i, h, g) {
        return h > i && (i = h), i > g && (i = g), i
    }

    var b = "mmenu", f = "dragOpen";
    d[b].prototype["_addon_" + f] = function () {
        var j = this, a = this.opts[f];
        if (d.fn.hammer) {
            var q = d[b]._c, C = (d[b]._d, d[b]._e);
            q.add("dragging"), C.add("dragleft dragright dragup dragdown dragend");
            var y = d[b].glbl;
            if ("boolean" == typeof a && (a = {open: a}), "object" != typeof a && (a = {}), "number" != typeof a.maxStartPos && (a.maxStartPos = "left" == this.opts.position || "right" == this.opts.position ? 150 : 75), a = d.extend(!0, {}, d[b].defaults[f], a), a.open) {
                var e = 0, w = !1, z = 0, t = 0, o = "width";
                ...
                switch (this.opts.position) {
                    case"left":
                        var x = {events: C.dragleft + " " + C.dragright, open_dir: "right", close_dir: "left", delta: "deltaX", page: "pageX", negative: !1};
                        break;
                    case"right":
                        var x = {events: C.dragleft + " " + C.dragright, open_dir: "left", close_dir: "right", delta: "deltaX", page: "pageX", negative: !0};
                        break;
                    case"top":
                        var x = {events: C.dragup + " " + C.dragdown, open_dir: "down", close_dir: "up", delta: "deltaY", page: "pageY", negative: !1};
                        break;
                    case"bottom":
                        var x = {events: C.dragup + " " + C.dragdown, open_dir: "up", close_dir: "down", delta: "deltaY", page: "pageY", negative: !0}
                }
                var B = this.__valueOrFn(a.pageNode, this.$menu, y.$page);
                "string" == typeof B && (B = d(B));
                var k = y.$page.find("." + q.mm("fixed-top") + ", ." + q.mm("fixed-bottom")), A = y.$page;
                switch (j.opts.zposition) {
                    case"back":
                        A = A.add(k);
                        break;
                    case"front":
                        ...
                        break;
                    case"next":
                        A = A.add(j.$menu).add(k)
                }
                B.hammer().on(C.touchstart + " " + C.mousedown, function (i) {
                    if ("touchstart" == i.type) {
                        var h = i.originalEvent.touches[0] || i.originalEvent.changedTouches[0], g = h[x.page]
                    } else {
                        if ("mousedown" == i.type) {
                            var g = i[x.page]
                        }
                    }
                    switch (j.opts.position) {
                        case"right":
                        case"bottom":
                            g >= y.$wndw[o]() - a.maxStartPos && (e = 1);
                            break;
                        default:
                            g <= a.maxStartPos && (e = 1)
                    }
                }).on(x.events + " " + C.dragend, function (g) {
                    e > 0 && (g.gesture.preventDefault(), g.stopPropagation())
                }).on(x.events, function (h) {
                    var g = x.negative ? -h.gesture[x.delta] : h.gesture[x.delta];
                    if (w = g > z ? x.open_dir : x.close_dir, z = g, z > a.threshold && 1 == e) {
                        if (y.$html.hasClass(q.opened)) {
                            return
                        }
                        e = 2, j._openSetup(), y.$html.addClass(q.dragging), t = c(y.$wndw[o]() * j.conf[f][o].perc, j.conf[f][o].min, j.conf[f][o].max)
                    }
                    2 == e && A.css(j.opts.position, c(z, 10, t) - ("front" == j.opts.zposition ? t : 0))
                }).on(C.dragend, function () {
                    2 == e && (y.$html.removeClass(q.dragging), A.css(j.opts.position, ""), w == x.open_dir ? j._openFinish() : j.close()), e = 0
                })
            }
        }
    }, d[b].defaults[f] = {open: !1, threshold: 50}, d[b].configuration[f] = {width: {perc: 0.8, min: 140, max: 440}, height: {perc: 0.8, min: 140, max: 880}}, d[b].addons = d[b].addons || [], d[b].addons.push(f)
}(jQuery);
!function (d) {
    var c = "mmenu", b = "header";
    d[c].prototype["_addon_" + b] = function () {
        var j = this, a = this.opts[b], v = this.conf[b], y = d[c]._c, m = (d[c]._d, d[c]._e);
        y.add("header hasheader prev next title titletext"), m.add("updateheader");
        var g = d[c].glbl;
        if ("boolean" == typeof a && (a = {add: a, update: a}), "object" != typeof a && (a = {}), a = d.extend(!0, {}, d[c].defaults[b], a), a.add) {
            var q = a.content ? a.content : '<a class="' + y.prev + '" href="#"></a><span class="' + y.title + '"></span><a class="' + y.next + '" href="#"></a>';
            d('<div class="' + y.header + '" />').prependTo(this.$menu).append(q)
        }
        var e = d("div." + y.header, this.$menu);
        if (e.length && this.$menu.addClass(y.hasheader), a.update && e.length) {
            var k = e.find("." + y.title), x = e.find("." + y.prev), t = e.find("." + y.next), w = "#" + g.$page.attr("id");
            x.add(t).on(m.click, function (h) {
                h.preventDefault(), h.stopPropagation();
                var f = d(this).attr("href");
                "#" !== f && (f == w ? j.$menu.trigger(m.close) : d(f, j.$menu).trigger(m.open))
            }), d("." + y.panel, this.$menu).each(function () {
                var h = d(this), f = d("." + v.panelHeaderClass, h).text(), l = d("." + v.panelPrevClass, h).attr("href"), i = d("." + v.panelNextClass, h).attr("href");
                f || (f = d("." + y.subclose, h).text()), f || (f = a.title), l || (l = d("." + y.subclose, h).attr("href")), h.off(m.updateheader).on(m.updateheader, function (n) {
                    n.stopPropagation(), k[f ? "show" : "hide"]().text(f), x[l ? "show" : "hide"]().attr("href", l), t[i ? "show" : "hide"]().attr("href", i)
                }), h.on(m.open, function () {
                    d(this).trigger(m.updateheader)
                })
            }).filter("." + y.current).trigger(m.updateheader)
        }
    }, d[c].defaults[b] = {add: !1, content: !1, update: !1, title: "Menu"}, d[c].configuration[b] = {panelHeaderClass: "Header", panelNextClass: "Next", panelPrevClass: "Prev"}, d[c].addons = d[c].addons || [], d[c].addons.push(b)
}(jQuery);
!function (c) {
    var a = "mmenu", b = "labels";
    c[a].prototype["_addon_" + b] = function () {
        function e() {
            var i = g.hassearch && l.$menu.hasClass(g.hassearch), d = g.hasheader && l.$menu.hasClass(g.hasheader);
            return i ? d ? 100 : 50 : d ? 60 : 0
        }

        var l = this, m = this.opts[b], g = c[a]._c, f = (c[a]._d, c[a]._e);
        if (g.add("collapsed"), g.add("fixedlabels original clone"), f.add("updatelabels position scroll"), c[a].support.touch && (f.scroll += " " + f.mm("touchmove")), "boolean" == typeof m && (m = {collapse: m}), "object" != typeof m && (m = {}), m = c.extend(!0, {}, c[a].defaults[b], m), m.collapse) {
            this.__refactorClass(c("li." + this.conf.collapsedClass, this.$menu), "collapsed");
            var k = c("." + g.label, this.$menu);
            k.each(function () {
                var d = c(this), i = d.nextUntil("." + g.label, "all" == m.collapse ? null : "." + g.collapsed);
                "all" == m.collapse && (d.addClass(g.opened), i.removeClass(g.collapsed)), i.length && (d.wrapInner("<span />"), c('<a href="#' + m.attr("id") + '" class="' + g.subopen + " " + g.fullsubopen + '" >').prependTo(d).on(f.click, function (n) {
                    n.preventDefault(), d.toggleClass(g.opened), i[d.hasClass(g.opened) ? "removeClass" : "addClass"](g.collapsed)
                }))
            })
        } else {
            if (m.fixed) {
                ...
                this.$menu.addClass(g.fixedlabels);
                var h = c("." + g.panel, this.$menu), k = c("." + g.label, this.$menu);
                h.add(k).off(f.updatelabels + " " + f.position + " " + f.scroll).on(f.updatelabels + " " + f.position + " " + f.scroll, function (d) {
                    d.stopPropagation()
                });
                var j = e();
                h.each(function () {
                    var d = c(this), i = d.find("." + g.label);
                    if (i.length) {
                        var n = d.scrollTop();
                        i.each(function () {
                            var p = c(this);
                            p.wrapInner("<div />").wrapInner("<div />");
                            var o, v, t, q = p.find("> div"), u = c();
                            p.on(f.updatelabels, function () {
                                n = d.scrollTop(), p.hasClass(g.hidden) || (u = p.nextAll("." + g.label).not("." + g.hidden).first(), o = p.offset().top + n, v = u.length ? u.offset().top + n : !1, t = q.height(), p.trigger(f.position))
                            }), p.on(f.position, function () {
                                var r = 0;
                                v && n + j > v - t ? r = v - o - t : n + j > o && (r = n - o + j), q.css("top", r)
                            })
                        }), d.on(f.updatelabels, function () {
                            n = d.scrollTop(), j = e(), i.trigger(f.position)
                        }).on(f.scroll, function () {
                            i.trigger(f.updatelabels)
                        })
                    }
                }), this.$menu.on(f.update, function () {
                    h.trigger(f.updatelabels)
                }).on(f.opening, function () {
                    h.trigger(f.updatelabels).trigger(f.scroll)
                })
            }
        }
    }, c[a].defaults[b] = {fixed: !1, collapse: !1}, c[a].configuration.collapsedClass = "Collapsed", c[a].addons = c[a].addons || [], c[a].addons.push(b)
}(jQuery);
!function (c) {
    function b(f) {
        switch (f) {
    ...
    var d = "mmenu", a = "searchfield";
    c[d].prototype["_addon_" + a] = function () {
        var s = this, e = this.opts[a], g = c[d]._c, j = c[d]._d, p = c[d]._e;
        if (g.add("search hassearch noresults nosubresults counter"), p.add("search reset change"), "boolean" == typeof e && (e = {add: e, search: e}), "object" != typeof e && (e = {}), e = c.extend(!0, {}, c[d].defaults[a], e), e.add && (c('<div class="' + g.search + '"><div class="chat-header">Contacts</div></div>').prependTo(this.$menu).append('<input placeholder="' + e.placeholder + '" type="text" autocomplete="off" />'), e.noResults && c("ul, ol", this.$menu).first().append('<li class="' + g.noresults + '">' + e.noResults + "</li>")), c("div." + g.search, this.$menu).length && this.$menu.addClass(g.hassearch), e.search) {
            var k = c("div." + g.search, this.$menu).find("input");
            if (k.length) {
                var t = c("." + g.panel, this.$menu), m = c("." + g.list + "> li." + g.label, this.$menu), q = c("." + g.list + "> li", this.$menu).not("." + g.subtitle).not("." + g.label).not("." + g.noresults), n = "> a";
                e.showLinksOnly || (n += ", > span .chat-name"), k.off(p.keyup + " " + p.change).on(p.keyup, function (f) {
                    b(f.keyCode) || s.$menu.trigger(p.search)
                }).on(p.change, function () {
                    s.$menu.trigger(p.search)
                }), this.$menu.off(p.reset + " " + p.search).on(p.reset + " " + p.search, function (f) {
                    f.stopPropagation()
                }).on(p.reset, function () {
                    s.$menu.trigger(p.search, [""])
                }).on(p.search, function (f, h) {
                    "string" == typeof h ? k.val(h) : h = k.val(), h = h.toLowerCase(), t.scrollTop(0), q.add(m).addClass(g.hidden), q.each(function () {
                        var i = c(this);
                        c(n, i).text().toLowerCase().indexOf(h) > -1 && i.add(i.prevAll("." + g.label).first()).removeClass(g.hidden)
                    }), c(t.get().reverse()).each(function () {
                        var l = c(this), o = l.data(j.parent);
                        if (o) {
                            var i = l.add(l.find("> ." + g.list)).find("> li").not("." + g.subtitle).not("." + g.label).not("." + g.hidden);
                            i.length ? o.removeClass(g.hidden).removeClass(g.nosubresults).prevAll("." + g.label).first().removeClass(g.hidden) : (l.hasClass(g.current) && o.trigger(p.open), o.addClass(g.nosubresults))
                        }
                    }), s.$menu[q.not("." + g.hidden).length ? "removeClass" : "addClass"](g.noresults), s.$menu.trigger(p.update)
                })
            }
        }
    }, c[d].defaults[a] = {add: !1, search: !1, showLinksOnly: !0, placeholder: "Search", noResults: "No results found."}, c[d].addons = c[d].addons || [], c[d].addons.push(a)
}(jQuery);
...
(function (a) {
    if (typeof module === "function") {
        module.exports = a(this.jQuery || require("jquery"))
    } else {
        if (typeof define === "function" && define.amd) {
            ...
            this.NProgress = a(this.jQuery)
        }
    }
})(function (e) {
    var a = {};
    a.version = "0.1.2";
    var b = a.settings = {minimum: 0.08, easing: "ease", positionUsing: "", speed: 200, trickle: true, trickleRate: 0.02, trickleSpeed: 800, showSpinner: true, template: '<div class="bar" role="bar"><div class="peg"></div></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>'};
    a.configure = function (g) {
        e.extend(b, g);
        return this
    };
    a.status = null;
    a.set = function (l) {
        ...
        l = f(l, b.minimum, 1);
        a.status = (l === 1 ? null : l);
        var g = a.render(!h), j = g.find('[role="bar"]'), i = b.speed, k = b.easing;
        g[0].offsetWidth;
        g.queue(function (m) {
            if (b.positionUsing === "") {
                b.positionUsing = a.getPositioningCSS()
            }
            j.css(c(l, i, k));
            if (l === 1) {
                g.css({transition: "none", opacity: 1});
                g[0].offsetWidth;
                setTimeout(function () {
                    g.css({transition: "all " + i + "ms linear", opacity: 0});
                    setTimeout(function () {
                        a.remove();
                        m()
                    }, i)
    ...
    a.inc = function (g) {
        ...
        if (!h) {
            ...
            if (typeof g !== "number") {
                g = (1 - h) * f(Math.random() * h, 0.1, 0.95)
            }
            h = f(h + g, 0, 0.994);
            return a.set(h)
        }
    ...
    a.render = function (g) {
        ...
        var i = e("<div id='nprogress'>").html(b.template);
        var h = g ? "-100" : d(a.status || 0);
        i.find('[role="bar"]').css({transition: "all 0 linear", transform: "translate3d(" + h + "%,0,0)"});
        if (!b.showSpinner) {
            i.find('[role="spinner"]').remove()
        }
    ...
    a.getPositioningCSS = function () {
        ...
        var h = ("WebkitTransform" in g) ? "Webkit" : ("MozTransform" in g) ? "Moz" : ("msTransform" in g) ? "ms" : ("OTransform" in g) ? "O" : "";
        if (h + "Perspective" in g) {
            return"translate3d"
        } else {
            if (h + "Transform" in g) {
                return"translate"
    ...
    function c(j, h, i) {
        ...
        if (b.positionUsing === "translate3d") {
            g = {transform: "translate3d(" + d(j) + "%,0,0)"}
        } else {
            if (b.positionUsing === "translate") {
                g = {transform: "translate(" + d(j) + "%,0)"}
            } else {
                g = {"margin-left": d(j) + "%"}
            }
        }
        g.transition = "all " + h + "ms " + i;
        return g
    }
...
(function (e, t, n, r) {
    ...
    var i = "numerator", s = {easing: "swing", duration: 500, delimiter: r, rounding: 0, toValue: r, fromValue: r, queue: false, onStart: function () {
    }, onStep: function () {
    }, onProgress: function () {
    }, onComplete: function () {
    }};
    o.prototype = {init: function () {
        ...
        var t = e(this.element).text().trim();
        this.settings.fromValue = this.format(t)
    }, setValue: function () {
        var t = this;
        e({value: t.settings.fromValue}).animate({value: t.settings.toValue}, {duration: parseInt(t.settings.duration), easing: t.settings.easing, start: t.settings.onStart, step: function (n, r) {
            e(t.element).text(t.format(n));
            t.settings.onStep(n, r)
        }, progress: t.settings.onProgress, complete: t.settings.onComplete})
    }, format: function (e) {
        var t = this;
        if (parseInt(this.settings.rounding) < 1) {
            e = parseInt(e)
        } else {
            e = parseFloat(e).toFixed(parseInt(this.settings.rounding))
        }
        if (t.settings.delimiter) {
            return this.delimit(e)
        } else {
            return e
        }
    }, delimit: function (e) {
        var t = this;
        e = e.toString();
        if (t.settings.rounding && parseInt(t.settings.rounding) > 0) {
            var n = e.substring(e.length - (t.settings.rounding + 1), e.length), r = e.substring(0, e.length - (t.settings.rounding + 1));
            return t.addCommas(r) + n
        } else {
            return t.addCommas(e)
        }
...
(function (e) {
    ...
    e.fn.setBreakpoints = function (r) {
        var i = jQuery.extend({distinct: true, breakpoints: new Array(320, 480, 768, 1024)}, r);
        n = setInterval(function () {
            var n = e(window).width();
            var r = false;
            for (var s in i.breakpoints.sort(function (e, t) {
                return t - e
            })) {
                if (!r && n >= i.breakpoints[s] && t < i.breakpoints[s]) {
                    if (i.distinct) {
                        for (var o in i.breakpoints.sort(function (e, t) {
                            return t - e
                        })) {
                            if (e("body").hasClass("breakpoint-" + i.breakpoints[o])) {
                                e("body").removeClass("breakpoint-" + i.breakpoints[o]);
                                e(window).trigger("exitBreakpoint" + i.breakpoints[o])
                            }
                        }
                        r = true
                    }
                    e("body").addClass("breakpoint-" + i.breakpoints[s]);
                    e(window).trigger("enterBreakpoint" + i.breakpoints[s])
                }
                if (n < i.breakpoints[s] && t >= i.breakpoints[s]) {
                    e("body").removeClass("breakpoint-" + i.breakpoints[s]);
                    e(window).trigger("exitBreakpoint" + i.breakpoints[s])
                }
                if (i.distinct && n >= i.breakpoints[s] && n < i.breakpoints[s - 1] && t > n && t > 0 && !e("body").hasClass("breakpoint-" + i.breakpoints[s])) {
                    e("body").addClass("breakpoint-" + i.breakpoints[s]);
                    e(window).trigger("enterBreakpoint" + i.breakpoints[s])
                }
            }
