    ...
    $('.send-message').keypress(function (e) {
        if (e.keyCode == 13) {
            var chat_message = '<li class="img">' +
                ...
                '<img src="/static/img/avatars/avatar1.png" data-retina-src="/static/img/avatars/avatar1_2x.png"/>' +
...
var setColor = function (color) {
    ...
    $('#theme-color').attr("href", "/static/css/colors/" + color_ + ".css");
    if ($.cookie) {         
...
if($.cookie('style-color')){
    ...
    $('#theme-color').attr("href", "/static/css/colors/color-dark.css");
}
...
if ($('.table-dynamic').length && $.fn.dataTable) {
    $('.table-dynamic').each(function () {
        ...
        if ($(this).hasClass('table-tools')) {
            ...
            opt.oTableTools = {
                "sSwfPath": "/static/plugins/datatables/swf/copy_csv_xls_pdf.swf",
...
/****  Function to multiselect rows on Shift+Click on Jqgrid  ****/
